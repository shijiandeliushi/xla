...
entry:
  %broadcast.2 = load ptr, ptr %buffer_table, align 8, !invariant.load !0, !dereferenceable !1, !align !2
  %0 = getelementptr inbounds ptr, ptr %buffer_table, i64 1
  %Arg_0.1 = load ptr, ptr %0, align 8, !invariant.load !0, !dereferenceable !3, !align !3
...
vector.body:                                      ; preds = %vector.body, %entry
  ...
  %2 = getelementptr inbounds [64 x float], ptr %broadcast.2, i64 0, i64 %index
  store <8 x float> %broadcast.splat, ptr %2, align 16, !alias.scope !4
  %index.next = add nuw i64 %index, 8
  %3 = icmp eq i64 %index.next, 64
  br i1 %3, label %broadcast.2.loop_exit.dim.0, label %vector.body, !llvm.loop !7

broadcast.2.loop_exit.dim.0:                      ; preds = %vector.body
  ret void
}
