...
broadcast_maximum_fusion.loop_header.dim.0:       ; preds = %broadcast_maximum_fusion.loop_exit.dim.1, %1
  ...
  %2 = icmp uge i64 %broadcast_maximum_fusion.indvar.dim.0, 10
...
broadcast_maximum_fusion.loop_header.dim.1:       ; preds = %broadcast_maximum_fusion.loop_body.dim.1, %broadcast_maximum_fusion.loop_body.dim.0
  ...
  %3 = icmp uge i64 %broadcast_maximum_fusion.indvar.dim.1, 64
...
broadcast_maximum_fusion.loop_body.dim.1:         ; preds = %broadcast_maximum_fusion.loop_header.dim.1
  %4 = getelementptr inbounds [10 x [64 x float]], ptr %arg0, i64 0, i64 %broadcast_maximum_fusion.indvar.dim.0, i64 %broadcast_maximum_fusion.indvar.dim.1
  %5 = load float, ptr %4, align 4
  %6 = getelementptr inbounds [64 x float], ptr %arg1, i64 0, i64 %broadcast_maximum_fusion.indvar.dim.1
  %7 = load float, ptr %6, align 4, !invariant.load !1, !noalias !5
  %add.0 = fadd float %5, %7
  %constant.0 = load float, ptr @0, align 4
  %8 = call float @llvm.maximum.f32(float %add.0, float %constant.0)
  %9 = getelementptr inbounds [10 x [64 x float]], ptr %arg2, i64 0, i64 %broadcast_maximum_fusion.indvar.dim.0, i64 %broadcast_maximum_fusion.indvar.dim.1
