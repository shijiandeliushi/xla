...
@broadcast_multiply_fusion.clone_parallel_bounds = private unnamed_addr constant [4 x [1 x [2 x i64]]] [[1 x [2 x i64]] [[2 x i64] [i64 0, i64 32]], [1 x [2 x i64]] [[2 x i64] [i64 32, i64 64]], [1 x [2 x i64]] [[2 x i64] [i64 64, i64 96]], [1 x [2 x i64]] [[2 x i64] [i64 96, i64 128]]]
...
vector.ph:                                        ; preds = %broadcast_multiply_fusion.clone.loop_exit.dim.1, %broadcast_multiply_fusion.clone.loop_header.dim.1.preheader.lr.ph
  %broadcast_multiply_fusion.clone.invar_address.dim.0.08 = phi i64 [ %lo_dim_0, %broadcast_multiply_fusion.clone.loop_header.dim.1.preheader.lr.ph ], [ %invar.inc, %broadcast_multiply_fusion.clone.loop_exit.dim.1 ]
  br label %vector.body

vector.body:                                      ; preds = %vector.body, %vector.ph
  %index = phi i64 [ 0, %vector.ph ], [ %index.next.3, %vector.body ]
  %3 = getelementptr inbounds [128 x [2048 x float]], ptr %arg0, i64 0, i64 %broadcast_multiply_fusion.clone.invar_address.dim.0.08, i64 %index
  ...
  %8 = fmul <8 x float> %broadcast.splat, %wide.load10
  %9 = fmul <8 x float> %broadcast.splat, %wide.load11
  %10 = fmul <8 x float> %broadcast.splat, %wide.load12
  %11 = getelementptr inbounds [128 x [2048 x float]], ptr %arg2, i64 0, i64 %broadcast_multiply_fusion.clone.invar_address.dim.0.08, i64 %index
  ...
  %15 = getelementptr inbounds [128 x [2048 x float]], ptr %arg0, i64 0, i64 %broadcast_multiply_fusion.clone.invar_address.dim.0.08, i64 %index.next
  ...
  %20 = fmul <8 x float> %broadcast.splat, %wide.load10.1
  %21 = fmul <8 x float> %broadcast.splat, %wide.load11.1
  %22 = fmul <8 x float> %broadcast.splat, %wide.load12.1
  %23 = getelementptr inbounds [128 x [2048 x float]], ptr %arg2, i64 0, i64 %broadcast_multiply_fusion.clone.invar_address.dim.0.08, i64 %index.next
  ...
  %27 = getelementptr inbounds [128 x [2048 x float]], ptr %arg0, i64 0, i64 %broadcast_multiply_fusion.clone.invar_address.dim.0.08, i64 %index.next.1
  ...
  %32 = fmul <8 x float> %broadcast.splat, %wide.load10.2
  %33 = fmul <8 x float> %broadcast.splat, %wide.load11.2
  %34 = fmul <8 x float> %broadcast.splat, %wide.load12.2
  %35 = getelementptr inbounds [128 x [2048 x float]], ptr %arg2, i64 0, i64 %broadcast_multiply_fusion.clone.invar_address.dim.0.08, i64 %index.next.1
  ...
  %39 = getelementptr inbounds [128 x [2048 x float]], ptr %arg0, i64 0, i64 %broadcast_multiply_fusion.clone.invar_address.dim.0.08, i64 %index.next.2
  ...
  %44 = fmul <8 x float> %broadcast.splat, %wide.load10.3
  %45 = fmul <8 x float> %broadcast.splat, %wide.load11.3
  %46 = fmul <8 x float> %broadcast.splat, %wide.load12.3
  %47 = getelementptr inbounds [128 x [2048 x float]], ptr %arg2, i64 0, i64 %broadcast_multiply_fusion.clone.invar_address.dim.0.08, i64 %index.next.2
  ...
  br i1 %51, label %broadcast_multiply_fusion.clone.loop_exit.dim.1, label %vector.body, !llvm.loop !8

broadcast_multiply_fusion.clone.loop_exit.dim.1:  ; preds = %vector.body
