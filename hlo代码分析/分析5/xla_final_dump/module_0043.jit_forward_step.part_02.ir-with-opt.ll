...
@multiply_multiply_fusion.1.clone_parallel_bounds = private unnamed_addr constant [12 x [1 x [2 x i64]]] [[1 x [2 x i64]] [[2 x i64] [i64 0, i64 10]], [1 x [2 x i64]] [[2 x i64] [i64 10, i64 20]], [1 x [2 x i64]] [[2 x i64] [i64 20, i64 30]], [1 x [2 x i64]] [[2 x i64] [i64 30, i64 40]], [1 x [2 x i64]] [[2 x i64] [i64 40, i64 50]], [1 x [2 x i64]] [[2 x i64] [i64 50, i64 60]], [1 x [2 x i64]] [[2 x i64] [i64 60, i64 70]], [1 x [2 x i64]] [[2 x i64] [i64 70, i64 80]], [1 x [2 x i64]] [[2 x i64] [i64 80, i64 90]], [1 x [2 x i64]] [[2 x i64] [i64 90, i64 100]], [1 x [2 x i64]] [[2 x i64] [i64 100, i64 110]], [1 x [2 x i64]] [[2 x i64] [i64 110, i64 128]]]

; Function Attrs: nofree norecurse nosync nounwind memory(readwrite, inaccessiblemem: none) uwtable
define noalias noundef ptr @multiply_multiply_fusion.1.clone(ptr readonly captures(none) %0) local_unnamed_addr #0 {
  ...
  %lo_dim_0_gep = getelementptr inbounds [12 x [1 x [2 x i64]]], ptr @multiply_multiply_fusion.1.clone_parallel_bounds, i64 0, i64 %workgroup_id_x, i64 0, i64 0
  %up_dim_0_gep = getelementptr inbounds [12 x [1 x [2 x i64]]], ptr @multiply_multiply_fusion.1.clone_parallel_bounds, i64 0, i64 %workgroup_id_x, i64 0, i64 1
...
vector.ph:                                        ; preds = %1, %multiply_multiply_fusion.1.clone.loop_exit.dim.1
  %multiply_multiply_fusion.1.clone.invar_address.dim.0.03 = phi i64 [ %invar.inc, %multiply_multiply_fusion.1.clone.loop_exit.dim.1 ], [ %lo_dim_0, %1 ]
  br label %vector.body

vector.body:                                      ; preds = %vector.body, %vector.ph
  %index = phi i64 [ 0, %vector.ph ], [ %index.next, %vector.body ]
  %2 = getelementptr inbounds [128 x [2048 x float]], ptr %arg0, i64 0, i64 %multiply_multiply_fusion.1.clone.invar_address.dim.0.03, i64 %index
  ...
  %41 = getelementptr inbounds [128 x [2048 x float]], ptr %arg2, i64 0, i64 %multiply_multiply_fusion.1.clone.invar_address.dim.0.03, i64 %index
  store <8 x float> %40, ptr %41, align 32, !alias.scope !5
  %index.next = add nuw i64 %index, 8
  %42 = icmp eq i64 %index.next, 2048
  br i1 %42, label %multiply_multiply_fusion.1.clone.loop_exit.dim.1, label %vector.body, !llvm.loop !8

multiply_multiply_fusion.1.clone.loop_exit.dim.1: ; preds = %vector.body
  %invar.inc = add nuw nsw i64 %multiply_multiply_fusion.1.clone.invar_address.dim.0.03, 1
  %exitcond4.not = icmp eq i64 %invar.inc, %up_dim_0
  br i1 %exitcond4.not, label %return, label %vector.ph, !llvm.loop !11

return:                                           ; preds = %multiply_multiply_fusion.1.clone.loop_exit.dim.1, %1
  ret ptr null
}
