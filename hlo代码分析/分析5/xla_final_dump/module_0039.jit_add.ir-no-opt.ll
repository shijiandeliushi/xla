...
broadcast_add_fusion.clone.loop_body.dim.1:       ; preds = %broadcast_add_fusion.clone.loop_header.dim.1
  %4 = load float, ptr %arg1, align 4, !invariant.load !1, !noalias !5
  %5 = getelementptr inbounds [128 x [2048 x float]], ptr %arg0, i64 0, i64 %broadcast_add_fusion.clone.indvar.dim.0, i64 %broadcast_add_fusion.clone.indvar.dim.1
  %6 = load float, ptr %5, align 4, !invariant.load !1, !noalias !5
  %add.1 = fadd float %4, %6
  %7 = getelementptr inbounds [128 x [2048 x float]], ptr %arg2, i64 0, i64 %broadcast_add_fusion.clone.indvar.dim.0, i64 %broadcast_add_fusion.clone.indvar.dim.1
  store float %add.1, ptr %7, align 4, !alias.scope !5
