...
@broadcast_multiply_fusion.clone_parallel_bounds = private constant [4 x [1 x [2 x i64]]] [[1 x [2 x i64]] [[2 x i64] [i64 0, i64 32]], [1 x [2 x i64]] [[2 x i64] [i64 32, i64 64]], [1 x [2 x i64]] [[2 x i64] [i64 64, i64 96]], [1 x [2 x i64]] [[2 x i64] [i64 96, i64 128]]]
...
broadcast_multiply_fusion.clone.loop_header.dim.1: ; preds = %broadcast_multiply_fusion.clone.loop_body.dim.1, %broadcast_multiply_fusion.clone.loop_body.dim.0
  ...
  %3 = icmp uge i64 %broadcast_multiply_fusion.clone.indvar.dim.1, 2048
...
broadcast_multiply_fusion.clone.loop_body.dim.1:  ; preds = %broadcast_multiply_fusion.clone.loop_header.dim.1
  ...
  %5 = getelementptr inbounds [128 x [2048 x float]], ptr %arg0, i64 0, i64 %broadcast_multiply_fusion.clone.indvar.dim.0, i64 %broadcast_multiply_fusion.clone.indvar.dim.1
  %6 = load float, ptr %5, align 4, !invariant.load !1, !noalias !5
  %multiply.1 = fmul float %4, %6
  %7 = getelementptr inbounds [128 x [2048 x float]], ptr %arg2, i64 0, i64 %broadcast_multiply_fusion.clone.indvar.dim.0, i64 %broadcast_multiply_fusion.clone.indvar.dim.1
