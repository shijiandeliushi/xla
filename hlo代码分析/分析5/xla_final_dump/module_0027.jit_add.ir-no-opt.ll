...
@broadcast_add_fusion.clone_parallel_bounds = private constant [4 x [1 x [2 x i64]]] [[1 x [2 x i64]] [[2 x i64] [i64 0, i64 32]], [1 x [2 x i64]] [[2 x i64] [i64 32, i64 64]], [1 x [2 x i64]] [[2 x i64] [i64 64, i64 96]], [1 x [2 x i64]] [[2 x i64] [i64 96, i64 128]]]
...
broadcast_add_fusion.clone.loop_body.dim.1:       ; preds = %broadcast_add_fusion.clone.loop_header.dim.1
  %4 = getelementptr inbounds [128 x [2048 x float]], ptr %arg0, i64 0, i64 %broadcast_add_fusion.clone.indvar.dim.0, i64 %broadcast_add_fusion.clone.indvar.dim.1
  %5 = load float, ptr %4, align 4, !invariant.load !1, !noalias !5
  %6 = getelementptr inbounds [1 x [2048 x float]], ptr %arg1, i64 0, i64 0, i64 %broadcast_add_fusion.clone.indvar.dim.1
  %7 = load float, ptr %6, align 4, !invariant.load !1, !noalias !5
  %add.1 = fadd float %5, %7
  %8 = getelementptr inbounds [128 x [2048 x float]], ptr %arg2, i64 0, i64 %broadcast_add_fusion.clone.indvar.dim.0, i64 %broadcast_add_fusion.clone.indvar.dim.1
...
broadcast_add_fusion.clone.loop_exit.dim.1:       ; preds = %broadcast_add_fusion.clone.loop_header.dim.1
  ...
  br label %broadcast_add_fusion.clone.loop_header.dim.0, !llvm.loop !8
