...
@__llvmsplit_unnamed.6 = private unnamed_addr constant [8 x i8] c"\00\08\00\00\00\00\00\00"
@broadcast_add_fusion.2.clone_parallel_bounds = private constant [4 x [1 x [2 x i64]]] [[1 x [2 x i64]] [[2 x i64] [i64 0, i64 512]], [1 x [2 x i64]] [[2 x i64] [i64 512, i64 1024]], [1 x [2 x i64]] [[2 x i64] [i64 1024, i64 1536]], [1 x [2 x i64]] [[2 x i64] [i64 1536, i64 2048]]]
...
broadcast_add_fusion.2.clone.loop_header.dim.1:   ; preds = %broadcast_add_fusion.2.clone.loop_body.dim.1, %broadcast_add_fusion.2.clone.loop_body.dim.0
  ...
  %3 = icmp uge i64 %broadcast_add_fusion.2.clone.indvar.dim.1, 2048
...
broadcast_add_fusion.2.clone.loop_body.dim.1:     ; preds = %broadcast_add_fusion.2.clone.loop_header.dim.1
  ...
  %13 = add i32 %10, %12
  %14 = getelementptr inbounds [2048 x [2048 x i32]], ptr %arg1, i64 0, i64 %broadcast_add_fusion.2.clone.indvar.dim.0, i64 %broadcast_add_fusion.2.clone.indvar.dim.1
