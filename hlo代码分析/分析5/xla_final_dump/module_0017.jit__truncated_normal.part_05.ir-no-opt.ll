...
@broadcast_add_fusion.1.clone_parallel_bounds = private constant [12 x [1 x [2 x i64]]] [[1 x [2 x i64]] [[2 x i64] [i64 0, i64 170]], [1 x [2 x i64]] [[2 x i64] [i64 170, i64 340]], [1 x [2 x i64]] [[2 x i64] [i64 340, i64 510]], [1 x [2 x i64]] [[2 x i64] [i64 510, i64 680]], [1 x [2 x i64]] [[2 x i64] [i64 680, i64 850]], [1 x [2 x i64]] [[2 x i64] [i64 850, i64 1020]], [1 x [2 x i64]] [[2 x i64] [i64 1020, i64 1190]], [1 x [2 x i64]] [[2 x i64] [i64 1190, i64 1360]], [1 x [2 x i64]] [[2 x i64] [i64 1360, i64 1530]], [1 x [2 x i64]] [[2 x i64] [i64 1530, i64 1700]], [1 x [2 x i64]] [[2 x i64] [i64 1700, i64 1870]], [1 x [2 x i64]] [[2 x i64] [i64 1870, i64 2048]]]
...
broadcast_add_fusion.1.clone.loop_header.dim.1:   ; preds = %broadcast_add_fusion.1.clone.loop_body.dim.1, %broadcast_add_fusion.1.clone.loop_body.dim.0
  ...
  %3 = icmp uge i64 %broadcast_add_fusion.1.clone.indvar.dim.1, 2048
...
broadcast_add_fusion.1.clone.loop_body.dim.1:     ; preds = %broadcast_add_fusion.1.clone.loop_header.dim.1
  %4 = getelementptr inbounds [2048 x [2048 x i32]], ptr %arg3, i64 0, i64 %broadcast_add_fusion.1.clone.indvar.dim.0, i64 %broadcast_add_fusion.1.clone.indvar.dim.1
  %5 = load i32, ptr %4, align 4, !invariant.load !1, !noalias !6
  %6 = getelementptr inbounds [2048 x [2048 x i32]], ptr %arg2, i64 0, i64 %broadcast_add_fusion.1.clone.indvar.dim.0, i64 %broadcast_add_fusion.1.clone.indvar.dim.1
  %7 = load i32, ptr %6, align 4, !invariant.load !1, !noalias !6
  %8 = add i32 %5, %7
  %9 = getelementptr inbounds [2048 x [2048 x i32]], ptr %arg2, i64 0, i64 %broadcast_add_fusion.1.clone.indvar.dim.0, i64 %broadcast_add_fusion.1.clone.indvar.dim.1
  ...
  %15 = getelementptr inbounds [2048 x [2048 x i32]], ptr %arg2, i64 0, i64 %broadcast_add_fusion.1.clone.indvar.dim.0, i64 %broadcast_add_fusion.1.clone.indvar.dim.1
  ...
  %44 = add i32 %42, %43
  %45 = getelementptr inbounds [2048 x [2048 x i32]], ptr %arg4, i64 0, i64 %broadcast_add_fusion.1.clone.indvar.dim.0, i64 %broadcast_add_fusion.1.clone.indvar.dim.1
