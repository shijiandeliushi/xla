...
@broadcast_add_fusion.1.clone_parallel_bounds = private unnamed_addr constant [12 x [1 x [2 x i64]]] [[1 x [2 x i64]] [[2 x i64] [i64 0, i64 170]], [1 x [2 x i64]] [[2 x i64] [i64 170, i64 340]], [1 x [2 x i64]] [[2 x i64] [i64 340, i64 510]], [1 x [2 x i64]] [[2 x i64] [i64 510, i64 680]], [1 x [2 x i64]] [[2 x i64] [i64 680, i64 850]], [1 x [2 x i64]] [[2 x i64] [i64 850, i64 1020]], [1 x [2 x i64]] [[2 x i64] [i64 1020, i64 1190]], [1 x [2 x i64]] [[2 x i64] [i64 1190, i64 1360]], [1 x [2 x i64]] [[2 x i64] [i64 1360, i64 1530]], [1 x [2 x i64]] [[2 x i64] [i64 1530, i64 1700]], [1 x [2 x i64]] [[2 x i64] [i64 1700, i64 1870]], [1 x [2 x i64]] [[2 x i64] [i64 1870, i64 2048]]]
...
vector.body169:                                   ; preds = %vector.body169, %vector.ph154
  ...
  %11 = getelementptr inbounds [2048 x [2048 x i32]], ptr %arg3, i64 0, i64 %broadcast_add_fusion.1.clone.invar_address.dim.0.03.us.us.us.us.us.us, i64 %index170
  %wide.load171 = load <8 x i32>, ptr %11, align 64, !invariant.load !1, !noalias !6
  %12 = getelementptr inbounds [2048 x [2048 x i32]], ptr %arg2, i64 0, i64 %broadcast_add_fusion.1.clone.invar_address.dim.0.03.us.us.us.us.us.us, i64 %index170
  ...
  %30 = getelementptr inbounds [2048 x [2048 x i32]], ptr %arg4, i64 0, i64 %broadcast_add_fusion.1.clone.invar_address.dim.0.03.us.us.us.us.us.us, i64 %index170
  store <8 x i32> %29, ptr %30, align 64, !alias.scope !6
  %index.next173 = or disjoint i64 %index170, 8
  %31 = getelementptr inbounds [2048 x [2048 x i32]], ptr %arg3, i64 0, i64 %broadcast_add_fusion.1.clone.invar_address.dim.0.03.us.us.us.us.us.us, i64 %index.next173
  %wide.load171.1 = load <8 x i32>, ptr %31, align 32, !invariant.load !1, !noalias !6
  %32 = getelementptr inbounds [2048 x [2048 x i32]], ptr %arg2, i64 0, i64 %broadcast_add_fusion.1.clone.invar_address.dim.0.03.us.us.us.us.us.us, i64 %index.next173
  ...
  %50 = getelementptr inbounds [2048 x [2048 x i32]], ptr %arg4, i64 0, i64 %broadcast_add_fusion.1.clone.invar_address.dim.0.03.us.us.us.us.us.us, i64 %index.next173
  store <8 x i32> %49, ptr %50, align 32, !alias.scope !6
  %index.next173.1 = add nuw nsw i64 %index170, 16
  %51 = icmp eq i64 %index.next173.1, 2048
...
vector.body146:                                   ; preds = %vector.body146, %vector.ph133
  ...
  %52 = getelementptr inbounds [2048 x [2048 x i32]], ptr %arg3, i64 0, i64 %broadcast_add_fusion.1.clone.invar_address.dim.0.03.us.us.us.us.us, i64 %index147
  %wide.load148 = load <8 x i32>, ptr %52, align 64, !invariant.load !1, !noalias !6
  %53 = getelementptr inbounds [2048 x [2048 x i32]], ptr %arg2, i64 0, i64 %broadcast_add_fusion.1.clone.invar_address.dim.0.03.us.us.us.us.us, i64 %index147
  ...
  %69 = getelementptr inbounds [2048 x [2048 x i32]], ptr %arg4, i64 0, i64 %broadcast_add_fusion.1.clone.invar_address.dim.0.03.us.us.us.us.us, i64 %index147
  store <8 x i32> %68, ptr %69, align 64, !alias.scope !6
  %index.next150 = or disjoint i64 %index147, 8
  %70 = getelementptr inbounds [2048 x [2048 x i32]], ptr %arg3, i64 0, i64 %broadcast_add_fusion.1.clone.invar_address.dim.0.03.us.us.us.us.us, i64 %index.next150
  %wide.load148.1 = load <8 x i32>, ptr %70, align 32, !invariant.load !1, !noalias !6
  %71 = getelementptr inbounds [2048 x [2048 x i32]], ptr %arg2, i64 0, i64 %broadcast_add_fusion.1.clone.invar_address.dim.0.03.us.us.us.us.us, i64 %index.next150
  ...
  %87 = getelementptr inbounds [2048 x [2048 x i32]], ptr %arg4, i64 0, i64 %broadcast_add_fusion.1.clone.invar_address.dim.0.03.us.us.us.us.us, i64 %index.next150
  store <8 x i32> %86, ptr %87, align 32, !alias.scope !6
  %index.next150.1 = add nuw nsw i64 %index147, 16
  %88 = icmp eq i64 %index.next150.1, 2048
...
vector.body125:                                   ; preds = %vector.body125, %vector.ph112
  ...
  %89 = getelementptr inbounds [2048 x [2048 x i32]], ptr %arg3, i64 0, i64 %broadcast_add_fusion.1.clone.invar_address.dim.0.03.us.us.us.us, i64 %index126
  %wide.load127 = load <8 x i32>, ptr %89, align 64, !invariant.load !1, !noalias !6
  %90 = getelementptr inbounds [2048 x [2048 x i32]], ptr %arg2, i64 0, i64 %broadcast_add_fusion.1.clone.invar_address.dim.0.03.us.us.us.us, i64 %index126
  ...
  %107 = getelementptr inbounds [2048 x [2048 x i32]], ptr %arg4, i64 0, i64 %broadcast_add_fusion.1.clone.invar_address.dim.0.03.us.us.us.us, i64 %index126
  store <8 x i32> %106, ptr %107, align 64, !alias.scope !6
  %index.next129 = or disjoint i64 %index126, 8
  %108 = getelementptr inbounds [2048 x [2048 x i32]], ptr %arg3, i64 0, i64 %broadcast_add_fusion.1.clone.invar_address.dim.0.03.us.us.us.us, i64 %index.next129
  %wide.load127.1 = load <8 x i32>, ptr %108, align 32, !invariant.load !1, !noalias !6
  %109 = getelementptr inbounds [2048 x [2048 x i32]], ptr %arg2, i64 0, i64 %broadcast_add_fusion.1.clone.invar_address.dim.0.03.us.us.us.us, i64 %index.next129
  ...
  %126 = getelementptr inbounds [2048 x [2048 x i32]], ptr %arg4, i64 0, i64 %broadcast_add_fusion.1.clone.invar_address.dim.0.03.us.us.us.us, i64 %index.next129
  store <8 x i32> %125, ptr %126, align 32, !alias.scope !6
  %index.next129.1 = add nuw nsw i64 %index126, 16
  %127 = icmp eq i64 %index.next129.1, 2048
...
vector.body104:                                   ; preds = %vector.body104, %vector.ph91
  ...
  %128 = getelementptr inbounds [2048 x [2048 x i32]], ptr %arg3, i64 0, i64 %broadcast_add_fusion.1.clone.invar_address.dim.0.03.us.us.us, i64 %index105
  %wide.load106 = load <8 x i32>, ptr %128, align 64, !invariant.load !1, !noalias !6
  %129 = getelementptr inbounds [2048 x [2048 x i32]], ptr %arg2, i64 0, i64 %broadcast_add_fusion.1.clone.invar_address.dim.0.03.us.us.us, i64 %index105
  ...
  %147 = getelementptr inbounds [2048 x [2048 x i32]], ptr %arg4, i64 0, i64 %broadcast_add_fusion.1.clone.invar_address.dim.0.03.us.us.us, i64 %index105
  store <8 x i32> %146, ptr %147, align 64, !alias.scope !6
  %index.next108 = or disjoint i64 %index105, 8
  %148 = getelementptr inbounds [2048 x [2048 x i32]], ptr %arg3, i64 0, i64 %broadcast_add_fusion.1.clone.invar_address.dim.0.03.us.us.us, i64 %index.next108
  %wide.load106.1 = load <8 x i32>, ptr %148, align 32, !invariant.load !1, !noalias !6
  %149 = getelementptr inbounds [2048 x [2048 x i32]], ptr %arg2, i64 0, i64 %broadcast_add_fusion.1.clone.invar_address.dim.0.03.us.us.us, i64 %index.next108
  ...
  %167 = getelementptr inbounds [2048 x [2048 x i32]], ptr %arg4, i64 0, i64 %broadcast_add_fusion.1.clone.invar_address.dim.0.03.us.us.us, i64 %index.next108
  store <8 x i32> %166, ptr %167, align 32, !alias.scope !6
  %index.next108.1 = add nuw nsw i64 %index105, 16
  %168 = icmp eq i64 %index.next108.1, 2048
...
vector.body83:                                    ; preds = %vector.body83, %vector.ph70
  ...
  %169 = getelementptr inbounds [2048 x [2048 x i32]], ptr %arg3, i64 0, i64 %broadcast_add_fusion.1.clone.invar_address.dim.0.03.us.us, i64 %index84
  %wide.load85 = load <8 x i32>, ptr %169, align 64, !invariant.load !1, !noalias !6
  %170 = getelementptr inbounds [2048 x [2048 x i32]], ptr %arg2, i64 0, i64 %broadcast_add_fusion.1.clone.invar_address.dim.0.03.us.us, i64 %index84
  ...
  %189 = getelementptr inbounds [2048 x [2048 x i32]], ptr %arg4, i64 0, i64 %broadcast_add_fusion.1.clone.invar_address.dim.0.03.us.us, i64 %index84
  store <8 x i32> %188, ptr %189, align 64, !alias.scope !6
  %index.next87 = or disjoint i64 %index84, 8
  %190 = getelementptr inbounds [2048 x [2048 x i32]], ptr %arg3, i64 0, i64 %broadcast_add_fusion.1.clone.invar_address.dim.0.03.us.us, i64 %index.next87
  %wide.load85.1 = load <8 x i32>, ptr %190, align 32, !invariant.load !1, !noalias !6
  %191 = getelementptr inbounds [2048 x [2048 x i32]], ptr %arg2, i64 0, i64 %broadcast_add_fusion.1.clone.invar_address.dim.0.03.us.us, i64 %index.next87
  ...
  %210 = getelementptr inbounds [2048 x [2048 x i32]], ptr %arg4, i64 0, i64 %broadcast_add_fusion.1.clone.invar_address.dim.0.03.us.us, i64 %index.next87
  store <8 x i32> %209, ptr %210, align 32, !alias.scope !6
  %index.next87.1 = add nuw nsw i64 %index84, 16
  %211 = icmp eq i64 %index.next87.1, 2048
...
vector.body62:                                    ; preds = %vector.body62, %vector.ph49
  ...
  %212 = getelementptr inbounds [2048 x [2048 x i32]], ptr %arg3, i64 0, i64 %broadcast_add_fusion.1.clone.invar_address.dim.0.03.us, i64 %index63
  %wide.load64 = load <8 x i32>, ptr %212, align 64, !invariant.load !1, !noalias !6
  %213 = getelementptr inbounds [2048 x [2048 x i32]], ptr %arg2, i64 0, i64 %broadcast_add_fusion.1.clone.invar_address.dim.0.03.us, i64 %index63
  ...
  %233 = getelementptr inbounds [2048 x [2048 x i32]], ptr %arg4, i64 0, i64 %broadcast_add_fusion.1.clone.invar_address.dim.0.03.us, i64 %index63
  store <8 x i32> %232, ptr %233, align 64, !alias.scope !6
  %index.next66 = or disjoint i64 %index63, 8
  %234 = getelementptr inbounds [2048 x [2048 x i32]], ptr %arg3, i64 0, i64 %broadcast_add_fusion.1.clone.invar_address.dim.0.03.us, i64 %index.next66
  %wide.load64.1 = load <8 x i32>, ptr %234, align 32, !invariant.load !1, !noalias !6
  %235 = getelementptr inbounds [2048 x [2048 x i32]], ptr %arg2, i64 0, i64 %broadcast_add_fusion.1.clone.invar_address.dim.0.03.us, i64 %index.next66
  ...
  %255 = getelementptr inbounds [2048 x [2048 x i32]], ptr %arg4, i64 0, i64 %broadcast_add_fusion.1.clone.invar_address.dim.0.03.us, i64 %index.next66
  store <8 x i32> %254, ptr %255, align 32, !alias.scope !6
  %index.next66.1 = add nuw nsw i64 %index63, 16
  %256 = icmp eq i64 %index.next66.1, 2048
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %257 = getelementptr inbounds [2048 x [2048 x i32]], ptr %arg3, i64 0, i64 %broadcast_add_fusion.1.clone.invar_address.dim.0.03, i64 %index
  %wide.load = load <8 x i32>, ptr %257, align 64, !invariant.load !1, !noalias !6
  %258 = getelementptr inbounds [2048 x [2048 x i32]], ptr %arg2, i64 0, i64 %broadcast_add_fusion.1.clone.invar_address.dim.0.03, i64 %index
  ...
  %279 = getelementptr inbounds [2048 x [2048 x i32]], ptr %arg4, i64 0, i64 %broadcast_add_fusion.1.clone.invar_address.dim.0.03, i64 %index
  store <8 x i32> %278, ptr %279, align 64, !alias.scope !6
  %index.next = or disjoint i64 %index, 8
  %280 = getelementptr inbounds [2048 x [2048 x i32]], ptr %arg3, i64 0, i64 %broadcast_add_fusion.1.clone.invar_address.dim.0.03, i64 %index.next
  %wide.load.1 = load <8 x i32>, ptr %280, align 32, !invariant.load !1, !noalias !6
  %281 = getelementptr inbounds [2048 x [2048 x i32]], ptr %arg2, i64 0, i64 %broadcast_add_fusion.1.clone.invar_address.dim.0.03, i64 %index.next
  ...
  %302 = getelementptr inbounds [2048 x [2048 x i32]], ptr %arg4, i64 0, i64 %broadcast_add_fusion.1.clone.invar_address.dim.0.03, i64 %index.next
  store <8 x i32> %301, ptr %302, align 32, !alias.scope !6
  %index.next.1 = add nuw nsw i64 %index, 16
  %303 = icmp eq i64 %index.next.1, 2048
...
!5 = !{i64 4}
!6 = !{!7}
!7 = !{!"result slice: {index:9, offset:16777280, size:16777216}", !8}
