...
define ptr @slice_add_fusion(ptr %0) #0 {
  %slice_add_fusion.invar_address.dim.0 = alloca i64, align 8
  ...
  store i64 0, ptr %slice_add_fusion.invar_address.dim.0, align 4
  br label %slice_add_fusion.loop_header.dim.0

slice_add_fusion.loop_header.dim.0:               ; preds = %slice_add_fusion.loop_body.dim.0, %1
  %slice_add_fusion.indvar.dim.0 = load i64, ptr %slice_add_fusion.invar_address.dim.0, align 4
  %2 = icmp uge i64 %slice_add_fusion.indvar.dim.0, 1
  br i1 %2, label %slice_add_fusion.loop_exit.dim.0, label %slice_add_fusion.loop_body.dim.0

slice_add_fusion.loop_body.dim.0:                 ; preds = %slice_add_fusion.loop_header.dim.0
  %3 = load i32, ptr %arg1, align 4, !invariant.load !1, !noalias !5
  %4 = add i64 %slice_add_fusion.indvar.dim.0, 1
  %5 = getelementptr inbounds [2 x i32], ptr %arg0, i64 0, i64 %4
  %6 = load i32, ptr %5, align 4, !invariant.load !1, !noalias !5
  %7 = add i32 %3, %6
  %8 = getelementptr inbounds [1 x i32], ptr %arg2, i64 0, i64 0
  store i32 %7, ptr %8, align 4, !alias.scope !5
  %invar.inc = add nuw nsw i64 %slice_add_fusion.indvar.dim.0, 1
  store i64 %invar.inc, ptr %slice_add_fusion.invar_address.dim.0, align 4
  br label %slice_add_fusion.loop_header.dim.0

slice_add_fusion.loop_exit.dim.0:                 ; preds = %slice_add_fusion.loop_header.dim.0
  br label %return

return:                                           ; preds = %slice_add_fusion.loop_exit.dim.0
  ret ptr null
}
...
!4 = !{i64 4}
!5 = !{!6}
!6 = !{!"result slice: {index:8, offset:768, size:4}", !7}
!7 = !{!"XLA host kernel slice_add_fusion AA domain"}
