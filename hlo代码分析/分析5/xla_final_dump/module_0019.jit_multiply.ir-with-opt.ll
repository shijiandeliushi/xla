...
@broadcast_multiply_fusion.clone_parallel_bounds = private unnamed_addr constant [4 x [1 x [2 x i64]]] [[1 x [2 x i64]] [[2 x i64] [i64 0, i64 512]], [1 x [2 x i64]] [[2 x i64] [i64 512, i64 1024]], [1 x [2 x i64]] [[2 x i64] [i64 1024, i64 1536]], [1 x [2 x i64]] [[2 x i64] [i64 1536, i64 2048]]]
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %3 = getelementptr inbounds [2048 x [2048 x float]], ptr %arg0, i64 0, i64 %broadcast_multiply_fusion.clone.invar_address.dim.0.08, i64 %index
  ...
  %11 = getelementptr inbounds [2048 x [2048 x float]], ptr %arg2, i64 0, i64 %broadcast_multiply_fusion.clone.invar_address.dim.0.08, i64 %index
  ...
  %15 = getelementptr inbounds [2048 x [2048 x float]], ptr %arg0, i64 0, i64 %broadcast_multiply_fusion.clone.invar_address.dim.0.08, i64 %index.next
  ...
  %23 = getelementptr inbounds [2048 x [2048 x float]], ptr %arg2, i64 0, i64 %broadcast_multiply_fusion.clone.invar_address.dim.0.08, i64 %index.next
  ...
  %27 = getelementptr inbounds [2048 x [2048 x float]], ptr %arg0, i64 0, i64 %broadcast_multiply_fusion.clone.invar_address.dim.0.08, i64 %index.next.1
  ...
  %35 = getelementptr inbounds [2048 x [2048 x float]], ptr %arg2, i64 0, i64 %broadcast_multiply_fusion.clone.invar_address.dim.0.08, i64 %index.next.1
  ...
  %39 = getelementptr inbounds [2048 x [2048 x float]], ptr %arg0, i64 0, i64 %broadcast_multiply_fusion.clone.invar_address.dim.0.08, i64 %index.next.2
  ...
  %47 = getelementptr inbounds [2048 x [2048 x float]], ptr %arg2, i64 0, i64 %broadcast_multiply_fusion.clone.invar_address.dim.0.08, i64 %index.next.2
