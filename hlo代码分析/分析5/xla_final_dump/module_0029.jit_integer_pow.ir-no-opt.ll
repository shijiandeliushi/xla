...
@multiply_multiply_fusion.clone_parallel_bounds = private constant [4 x [1 x [2 x i64]]] [[1 x [2 x i64]] [[2 x i64] [i64 0, i64 32]], [1 x [2 x i64]] [[2 x i64] [i64 32, i64 64]], [1 x [2 x i64]] [[2 x i64] [i64 64, i64 96]], [1 x [2 x i64]] [[2 x i64] [i64 96, i64 128]]]
...
multiply_multiply_fusion.clone.loop_body.dim.1:   ; preds = %multiply_multiply_fusion.clone.loop_header.dim.1
  ...
  %6 = getelementptr inbounds [128 x [2048 x float]], ptr %arg0, i64 0, i64 %multiply_multiply_fusion.clone.indvar.dim.0, i64 %multiply_multiply_fusion.clone.indvar.dim.1
  %7 = load float, ptr %6, align 4, !invariant.load !1, !noalias !4
  %multiply.5 = fmul float %5, %7
  %8 = getelementptr inbounds [128 x [2048 x float]], ptr %arg0, i64 0, i64 %multiply_multiply_fusion.clone.indvar.dim.0, i64 %multiply_multiply_fusion.clone.indvar.dim.1
  %9 = load float, ptr %8, align 4, !invariant.load !1, !noalias !4
  %multiply.4 = fmul float %multiply.5, %9
  %10 = getelementptr inbounds [128 x [2048 x float]], ptr %arg1, i64 0, i64 %multiply_multiply_fusion.clone.indvar.dim.0, i64 %multiply_multiply_fusion.clone.indvar.dim.1
  store float %multiply.4, ptr %10, align 4, !alias.scope !4
...
multiply_multiply_fusion.clone.loop_exit.dim.1:   ; preds = %multiply_multiply_fusion.clone.loop_header.dim.1
  ...
  br label %multiply_multiply_fusion.clone.loop_header.dim.0, !llvm.loop !7
