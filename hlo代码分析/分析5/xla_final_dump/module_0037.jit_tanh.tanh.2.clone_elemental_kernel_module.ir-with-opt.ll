...
@tanh.2.clone_parallel_bounds = private unnamed_addr constant [4 x [1 x [2 x i64]]] [[1 x [2 x i64]] [[2 x i64] [i64 0, i64 32]], [1 x [2 x i64]] [[2 x i64] [i64 32, i64 64]], [1 x [2 x i64]] [[2 x i64] [i64 64, i64 96]], [1 x [2 x i64]] [[2 x i64] [i64 96, i64 128]]]
...
vector.ph:                                        ; preds = %1, %tanh.2.clone.loop_exit.dim.1
  %tanh.2.clone.invar_address.dim.0.06 = phi i64 [ %invar.inc, %tanh.2.clone.loop_exit.dim.1 ], [ %lo_dim_0, %1 ]
  br label %vector.body

vector.body:                                      ; preds = %vector.body, %vector.ph
  %index = phi i64 [ 0, %vector.ph ], [ %index.next, %vector.body ]
  %2 = getelementptr inbounds [128 x [2048 x float]], ptr %arg0, i64 0, i64 %tanh.2.clone.invar_address.dim.0.06, i64 %index
  ...
  %34 = call <8 x float> @llvm.fabs.v8f32(<8 x float> %wide.load8)
  %35 = fcmp olt <8 x float> %34, splat (float 0x3F3A36E2E0000000)
  %36 = fcmp uge <8 x float> %wide.load8, splat (float 0xC01FFEC880000000)
  %37 = select <8 x i1> %36, <8 x float> %wide.load8, <8 x float> splat (float 0xC01FFEC880000000)
  ...
  %61 = select <8 x i1> %35, <8 x float> %wide.load8, <8 x float> %60
  %62 = call <8 x float> @llvm.fabs.v8f32(<8 x float> %wide.load9)
  %63 = fcmp olt <8 x float> %62, splat (float 0x3F3A36E2E0000000)
  %64 = fcmp uge <8 x float> %wide.load9, splat (float 0xC01FFEC880000000)
  %65 = select <8 x i1> %64, <8 x float> %wide.load9, <8 x float> splat (float 0xC01FFEC880000000)
  ...
  %89 = select <8 x i1> %63, <8 x float> %wide.load9, <8 x float> %88
  %90 = call <8 x float> @llvm.fabs.v8f32(<8 x float> %wide.load10)
  %91 = fcmp olt <8 x float> %90, splat (float 0x3F3A36E2E0000000)
  %92 = fcmp uge <8 x float> %wide.load10, splat (float 0xC01FFEC880000000)
  %93 = select <8 x i1> %92, <8 x float> %wide.load10, <8 x float> splat (float 0xC01FFEC880000000)
  ...
  %117 = select <8 x i1> %91, <8 x float> %wide.load10, <8 x float> %116
  %118 = getelementptr inbounds [128 x [2048 x float]], ptr %arg1, i64 0, i64 %tanh.2.clone.invar_address.dim.0.06, i64 %index
  ...
  %122 = icmp eq i64 %index.next, 2048
  br i1 %122, label %tanh.2.clone.loop_exit.dim.1, label %vector.body, !llvm.loop !7

tanh.2.clone.loop_exit.dim.1:                     ; preds = %vector.body
  %invar.inc = add nuw nsw i64 %tanh.2.clone.invar_address.dim.0.06, 1
