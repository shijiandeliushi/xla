...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %14 = getelementptr inbounds [1024 x [512 x i32]], ptr %arg1, i64 0, i64 %broadcast_add_fusion.2.clone.invar_address.dim.0.03, i64 %index
  ...
  %26 = getelementptr inbounds [1024 x [512 x i32]], ptr %arg1, i64 0, i64 %broadcast_add_fusion.2.clone.invar_address.dim.0.03, i64 %index.next
...
!4 = !{i64 8}
!5 = !{!6}
!6 = !{!"result slice: {index:9, offset:64, size:2097152}", !7}
