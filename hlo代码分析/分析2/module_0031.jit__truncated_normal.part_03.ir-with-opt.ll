...
return:
  ...
  %multiply.25 = fmul float %2, 0x3FE6A09E60000000
  %3 = tail call float @llvm.fabs.f32(float %multiply.25)
  %4 = fcmp oge float %3, 0x400EA8F960000000
  %5 = fmul float %multiply.25, %multiply.25
  ...
  %17 = tail call float @llvm.copysign.f32(float 1.000000e+00, float %multiply.25)
  %18 = fdiv float %10, %16
...
!3 = !{i64 64}
!4 = !{!5}
!5 = !{!"result slice: {index:9, offset:1573248, size:4}", !6}
