...
broadcast.2.loop_header.dim.0:                    ; preds = %broadcast.2.loop_body.dim.0, %1
  ...
  %2 = icmp uge i64 %broadcast.2.indvar.dim.0, 128
...
broadcast.2.loop_body.dim.0:                      ; preds = %broadcast.2.loop_header.dim.0
  ...
  %4 = getelementptr inbounds [128 x float], ptr %arg1, i64 0, i64 %broadcast.2.indvar.dim.0
...
!4 = !{i64 512}
!5 = !{!6}
!6 = !{!"result slice: {index:0, offset:0, size:512}", !7}
