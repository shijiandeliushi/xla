...
broadcast_add_fusion.clone.loop_body.dim.1:       ; preds = %broadcast_add_fusion.clone.loop_header.dim.1
  %4 = getelementptr inbounds [1024 x [512 x i32]], ptr %arg3, i64 0, i64 %broadcast_add_fusion.clone.indvar.dim.0, i64 %broadcast_add_fusion.clone.indvar.dim.1
  %5 = load i32, ptr %4, align 4, !invariant.load !1, !noalias !6
  %6 = getelementptr inbounds [1024 x [512 x i32]], ptr %arg2, i64 0, i64 %broadcast_add_fusion.clone.indvar.dim.0, i64 %broadcast_add_fusion.clone.indvar.dim.1
  %7 = load i32, ptr %6, align 4, !invariant.load !1, !noalias !6
  %8 = add i32 %5, %7
  %9 = getelementptr inbounds [1024 x [512 x i32]], ptr %arg2, i64 0, i64 %broadcast_add_fusion.clone.indvar.dim.0, i64 %broadcast_add_fusion.clone.indvar.dim.1
  ...
  %15 = getelementptr inbounds [1024 x [512 x i32]], ptr %arg2, i64 0, i64 %broadcast_add_fusion.clone.indvar.dim.0, i64 %broadcast_add_fusion.clone.indvar.dim.1
  ...
  %56 = add i32 %53, %55
  %57 = getelementptr inbounds [1024 x [512 x i32]], ptr %arg5, i64 0, i64 %broadcast_add_fusion.clone.indvar.dim.0, i64 %broadcast_add_fusion.clone.indvar.dim.1
