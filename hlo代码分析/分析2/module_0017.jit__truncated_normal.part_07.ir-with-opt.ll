...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %30 = getelementptr inbounds [1024 x [512 x i32]], ptr %arg2, i64 0, i64 %maximum_minimum_fusion.clone.invar_address.dim.0.03, i64 %index
  %wide.load = load <8 x i32>, ptr %30, align 32, !invariant.load !1, !noalias !5
  %31 = getelementptr inbounds [1024 x [512 x i32]], ptr %arg3, i64 0, i64 %maximum_minimum_fusion.clone.invar_address.dim.0.03, i64 %index
  ...
  %134 = getelementptr inbounds [1024 x [512 x float]], ptr %arg6, i64 0, i64 %maximum_minimum_fusion.clone.invar_address.dim.0.03, i64 %index
  store <8 x float> %133, ptr %134, align 32, !alias.scope !5
  %index.next = add nuw i64 %index, 8
  %135 = icmp eq i64 %index.next, 512
