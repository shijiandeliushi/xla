module @broadcast_add_fusion_kernel_module attributes {dlti.dl_spec = #dlti.dl_spec<index = 64 : i32>, xla.cpu_memory_region_name = "xla_cpu_emitter__loop_fusion_kernel_emitter__hlo_opcode__fusion"} {
  llvm.func @broadcast_add_fusion(%arg0: !llvm.ptr) -> !llvm.ptr attributes {frame_pointer = #llvm.framePointerKind<all>, passthrough = [["prefer-vector-width", "256"]], uwtable_kind = #llvm.uwtableKind<async>} {
    ...
    llvm.call @broadcast_add_fusion_wrapped(%4, %6, %8, %12, %14, %16) : (!llvm.ptr, !llvm.ptr, !llvm.ptr, i64, i64, i64) -> ()
    llvm.return %0 : !llvm.ptr
  }
  llvm.func internal @broadcast_add_fusion_wrapped(%arg0: !llvm.ptr {llvm.align = 64 : index, llvm.dereferenceable = 32768 : index, llvm.noalias}, %arg1: !llvm.ptr {llvm.align = 64 : index, llvm.dereferenceable = 512 : index, llvm.noalias, xla.invariant}, %arg2: !llvm.ptr {llvm.align = 64 : index, llvm.dereferenceable = 32768 : index, llvm.noalias}, %arg3: i64, %arg4: i64, %arg5: i64) attributes {always_inline, sym_visibility = "private", xla.backend_kind = #xla.backend_kind<cpu>, xla.cpu.is_wrapped, xla.entry} {
  ...
  ^bb4:  // pred: ^bb3
    ...
    %10 = llvm.getelementptr inbounds %arg0[0, %9] : (!llvm.ptr, i64) -> !llvm.ptr, !llvm.array<8192 x f32>
    %11 = llvm.load %10 : !llvm.ptr -> f32
    %12 = llvm.getelementptr inbounds %arg1[0, %7] : (!llvm.ptr, i64) -> !llvm.ptr, !llvm.array<128 x f32>
    %13 = llvm.load %12 invariant : !llvm.ptr -> f32
    %14 = llvm.fadd %11, %13 : f32
    llvm.store %14, %10 : f32, !llvm.ptr
    %15 = llvm.add %7, %0 : i64
    llvm.br ^bb3(%15 : i64)
  ^bb5:  // pred: ^bb3
    %16 = llvm.add %4, %0 : i64
