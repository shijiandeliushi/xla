...
define ptr @broadcast_maximum_fusion.1(ptr %0) #0 {
  ...
  call void @broadcast_maximum_fusion.1_wrapped(ptr %5, ptr %7, ptr %9, i64 %13, i64 %15, i64 %17)
  ret ptr null
}

; Function Attrs: alwaysinline
define internal void @broadcast_maximum_fusion.1_wrapped(ptr noalias align 64 dereferenceable(131072) %0, ptr noalias align 64 dereferenceable(2048) %1, ptr noalias align 64 dereferenceable(131072) %2, i64 %3, i64 %4, i64 %5) #1 {
  br label %7
...
15:                                               ; preds = %12
  ...
  %17 = getelementptr inbounds [32768 x float], ptr %0, i32 0, i64 %16
  %18 = load float, ptr %17, align 4
  %19 = getelementptr inbounds [512 x float], ptr %1, i32 0, i64 %13
