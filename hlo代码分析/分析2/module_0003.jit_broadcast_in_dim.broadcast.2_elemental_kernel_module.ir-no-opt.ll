...
broadcast.2.loop_header.dim.1:                    ; preds = %broadcast.2.loop_body.dim.1, %broadcast.2.loop_body.dim.0
  ...
  %3 = icmp uge i64 %broadcast.2.indvar.dim.1, 1024
...
broadcast.2.loop_body.dim.1:                      ; preds = %broadcast.2.loop_header.dim.1
  ...
  %5 = getelementptr inbounds [64 x [1024 x float]], ptr %arg1, i64 0, i64 %broadcast.2.indvar.dim.0, i64 %broadcast.2.indvar.dim.1
