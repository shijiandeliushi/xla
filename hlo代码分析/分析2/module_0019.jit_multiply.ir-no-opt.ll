...
broadcast_multiply_fusion.clone.loop_body.dim.1:  ; preds = %broadcast_multiply_fusion.clone.loop_header.dim.1
  %4 = getelementptr inbounds [1024 x [512 x float]], ptr %arg0, i64 0, i64 %broadcast_multiply_fusion.clone.indvar.dim.0, i64 %broadcast_multiply_fusion.clone.indvar.dim.1
  ...
  %7 = getelementptr inbounds [1024 x [512 x float]], ptr %arg2, i64 0, i64 %broadcast_multiply_fusion.clone.indvar.dim.0, i64 %broadcast_multiply_fusion.clone.indvar.dim.1
