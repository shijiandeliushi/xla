...
@__llvmsplit_unnamed.8 = private unnamed_addr constant [8 x i8] c"\80\00\00\00\00\00\00\00"
@broadcast_add_fusion.3.clone_parallel_bounds = private constant [12 x [1 x [2 x i64]]] [[1 x [2 x i64]] [[2 x i64] [i64 0, i64 21]], [1 x [2 x i64]] [[2 x i64] [i64 21, i64 42]], [1 x [2 x i64]] [[2 x i64] [i64 42, i64 63]], [1 x [2 x i64]] [[2 x i64] [i64 63, i64 84]], [1 x [2 x i64]] [[2 x i64] [i64 84, i64 105]], [1 x [2 x i64]] [[2 x i64] [i64 105, i64 126]], [1 x [2 x i64]] [[2 x i64] [i64 126, i64 147]], [1 x [2 x i64]] [[2 x i64] [i64 147, i64 168]], [1 x [2 x i64]] [[2 x i64] [i64 168, i64 189]], [1 x [2 x i64]] [[2 x i64] [i64 189, i64 210]], [1 x [2 x i64]] [[2 x i64] [i64 210, i64 231]], [1 x [2 x i64]] [[2 x i64] [i64 231, i64 256]]]
...
broadcast_add_fusion.3.clone.loop_header.dim.1:   ; preds = %broadcast_add_fusion.3.clone.loop_body.dim.1, %broadcast_add_fusion.3.clone.loop_body.dim.0
  ...
  %3 = icmp uge i64 %broadcast_add_fusion.3.clone.indvar.dim.1, 128
...
broadcast_add_fusion.3.clone.loop_body.dim.1:     ; preds = %broadcast_add_fusion.3.clone.loop_header.dim.1
  ...
  %constant.173 = load i64, ptr @__llvmsplit_unnamed.8, align 4
  %6 = mul i64 %5, %constant.173
  %7 = mul nuw nsw i64 %broadcast_add_fusion.3.clone.indvar.dim.1, 1
  %8 = add nuw nsw i64 0, %7
  %9 = add i64 %6, %8
  %constant.172 = load i64, ptr @__llvmsplit_unnamed.7, align 4
  %10 = lshr i64 %9, %constant.172
  %shft.chk = icmp ult i64 %constant.172, 64
  ...
  %15 = add i32 %12, %14
  %16 = getelementptr inbounds [256 x [128 x i32]], ptr %arg1, i64 0, i64 %broadcast_add_fusion.3.clone.indvar.dim.0, i64 %broadcast_add_fusion.3.clone.indvar.dim.1
