...
@__llvmsplit_unnamed.6 = private unnamed_addr constant [8 x i8] c"\80\00\00\00\00\00\00\00"

; Function Attrs: uwtable
define ptr @broadcast_add_fusion.2(ptr %0) #0 {
  %broadcast_add_fusion.2.invar_address.dim.1 = alloca i64, align 8
...
broadcast_add_fusion.2.loop_header.dim.0:         ; preds = %broadcast_add_fusion.2.loop_exit.dim.1, %1
  %broadcast_add_fusion.2.indvar.dim.0 = load i64, ptr %broadcast_add_fusion.2.invar_address.dim.0, align 4
  %2 = icmp uge i64 %broadcast_add_fusion.2.indvar.dim.0, 256
...
broadcast_add_fusion.2.loop_body.dim.0:           ; preds = %broadcast_add_fusion.2.loop_header.dim.0
  store i64 0, ptr %broadcast_add_fusion.2.invar_address.dim.1, align 4
  br label %broadcast_add_fusion.2.loop_header.dim.1

broadcast_add_fusion.2.loop_header.dim.1:         ; preds = %broadcast_add_fusion.2.loop_body.dim.1, %broadcast_add_fusion.2.loop_body.dim.0
  %broadcast_add_fusion.2.indvar.dim.1 = load i64, ptr %broadcast_add_fusion.2.invar_address.dim.1, align 4
  %3 = icmp uge i64 %broadcast_add_fusion.2.indvar.dim.1, 128
  br i1 %3, label %broadcast_add_fusion.2.loop_exit.dim.1, label %broadcast_add_fusion.2.loop_body.dim.1

broadcast_add_fusion.2.loop_body.dim.1:           ; preds = %broadcast_add_fusion.2.loop_header.dim.1
  %4 = mul nuw nsw i64 %broadcast_add_fusion.2.indvar.dim.0, 1
  %5 = add nuw nsw i64 0, %4
  %constant.128 = load i64, ptr @__llvmsplit_unnamed.6, align 4
  %6 = mul i64 %5, %constant.128
  %7 = mul nuw nsw i64 %broadcast_add_fusion.2.indvar.dim.1, 1
  ...
  %13 = add i32 %10, %12
  %14 = getelementptr inbounds [256 x [128 x i32]], ptr %arg1, i64 0, i64 %broadcast_add_fusion.2.indvar.dim.0, i64 %broadcast_add_fusion.2.indvar.dim.1
  store i32 %13, ptr %14, align 4, !alias.scope !5
  %invar.inc3 = add nuw nsw i64 %broadcast_add_fusion.2.indvar.dim.1, 1
  store i64 %invar.inc3, ptr %broadcast_add_fusion.2.invar_address.dim.1, align 4
  br label %broadcast_add_fusion.2.loop_header.dim.1

broadcast_add_fusion.2.loop_exit.dim.1:           ; preds = %broadcast_add_fusion.2.loop_header.dim.1
  ...
  br label %broadcast_add_fusion.2.loop_header.dim.0, !llvm.loop !8
