...
@broadcast_add_fusion.2.clone_parallel_bounds = private unnamed_addr constant [4 x [1 x [2 x i64]]] [[1 x [2 x i64]] [[2 x i64] [i64 0, i64 256]], [1 x [2 x i64]] [[2 x i64] [i64 256, i64 512]], [1 x [2 x i64]] [[2 x i64] [i64 512, i64 768]], [1 x [2 x i64]] [[2 x i64] [i64 768, i64 1024]]]
...
vector.ph:                                        ; preds = %broadcast_add_fusion.2.clone.loop_exit.dim.1, %broadcast_add_fusion.2.clone.loop_header.dim.1.preheader.lr.ph
  ...
  %4 = shl i64 %broadcast_add_fusion.2.clone.invar_address.dim.0.03, 12
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %14 = getelementptr inbounds [1024 x [4096 x i32]], ptr %arg1, i64 0, i64 %broadcast_add_fusion.2.clone.invar_address.dim.0.03, i64 %index
  ...
  %26 = getelementptr inbounds [1024 x [4096 x i32]], ptr %arg1, i64 0, i64 %broadcast_add_fusion.2.clone.invar_address.dim.0.03, i64 %index.next
