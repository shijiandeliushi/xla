...
define ptr @broadcast_divide_fusion.clone(ptr %0) #0 {
...
broadcast_divide_fusion.clone.loop_body.dim.3:    ; preds = %broadcast_divide_fusion.clone.loop_header.dim.3
  ...
  %8 = load float, ptr %arg1, align 4, !invariant.load !1, !noalias !5
  %divide.1 = fdiv float %7, %8
  %9 = getelementptr inbounds [32 x [16 x [512 x [512 x float]]]], ptr %arg2, i64 0, i64 %broadcast_divide_fusion.clone.indvar.dim.0, i64 %broadcast_divide_fusion.clone.indvar.dim.1, i64 %broadcast_divide_fusion.clone.indvar.dim.2, i64 %broadcast_divide_fusion.clone.indvar.dim.3
  store float %divide.1, ptr %9, align 4, !alias.scope !5
...
broadcast_divide_fusion.clone.loop_exit.dim.3:    ; preds = %broadcast_divide_fusion.clone.loop_header.dim.3
  ...
  br label %broadcast_divide_fusion.clone.loop_header.dim.2, !llvm.loop !8
...
broadcast_divide_fusion.clone.loop_exit.dim.2:    ; preds = %broadcast_divide_fusion.clone.loop_header.dim.2
  ...
  br label %broadcast_divide_fusion.clone.loop_header.dim.1, !llvm.loop !10
...
broadcast_divide_fusion.clone.loop_exit.dim.1:    ; preds = %broadcast_divide_fusion.clone.loop_header.dim.1
  ...
  br label %broadcast_divide_fusion.clone.loop_header.dim.0, !llvm.loop !11
