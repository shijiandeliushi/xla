...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %2 = getelementptr inbounds nuw [4096 x float], ptr %arg1, i64 0, i64 %index
  ...
  %6 = getelementptr inbounds nuw [4096 x float], ptr %arg1, i64 0, i64 %index.next
  ...
  %10 = getelementptr inbounds nuw [4096 x float], ptr %arg1, i64 0, i64 %index.next.1
  ...
  %14 = getelementptr inbounds nuw [4096 x float], ptr %arg1, i64 0, i64 %index.next.2
  ...
  %18 = getelementptr inbounds nuw [4096 x float], ptr %arg1, i64 0, i64 %index.next.3
  ...
  %22 = getelementptr inbounds nuw [4096 x float], ptr %arg1, i64 0, i64 %index.next.4
  ...
  %26 = getelementptr inbounds nuw [4096 x float], ptr %arg1, i64 0, i64 %index.next.5
  ...
  %30 = getelementptr inbounds nuw [4096 x float], ptr %arg1, i64 0, i64 %index.next.6
  ...
  %34 = icmp eq i64 %index.next.7, 4096
...
!4 = !{i64 4}
!5 = !{!6}
!6 = !{!"result slice: {index:0, offset:0, size:16384}", !7}
