...
@tanh.2.clone_parallel_bounds = private constant [4 x [1 x [2 x i64]]] [[1 x [2 x i64]] [[2 x i64] [i64 0, i64 8]], [1 x [2 x i64]] [[2 x i64] [i64 8, i64 16]], [1 x [2 x i64]] [[2 x i64] [i64 16, i64 24]], [1 x [2 x i64]] [[2 x i64] [i64 24, i64 32]]]

; Function Attrs: uwtable
define ptr @tanh.2.clone_kernel(ptr %0) #0 {
  %tanh.2.clone.invar_address.dim.2 = alloca i64, align 8
...
tanh.2.clone.loop_header.dim.1:                   ; preds = %tanh.2.clone.loop_exit.dim.2, %tanh.2.clone.loop_body.dim.0
  %tanh.2.clone.indvar.dim.1 = load i64, ptr %tanh.2.clone.invar_address.dim.1, align 4
  %3 = icmp uge i64 %tanh.2.clone.indvar.dim.1, 512
...
tanh.2.clone.loop_body.dim.1:                     ; preds = %tanh.2.clone.loop_header.dim.1
  store i64 0, ptr %tanh.2.clone.invar_address.dim.2, align 4
  br label %tanh.2.clone.loop_header.dim.2

tanh.2.clone.loop_header.dim.2:                   ; preds = %tanh.2.clone.loop_body.dim.2, %tanh.2.clone.loop_body.dim.1
  %tanh.2.clone.indvar.dim.2 = load i64, ptr %tanh.2.clone.invar_address.dim.2, align 4
  %4 = icmp uge i64 %tanh.2.clone.indvar.dim.2, 4096
  br i1 %4, label %tanh.2.clone.loop_exit.dim.2, label %tanh.2.clone.loop_body.dim.2

tanh.2.clone.loop_body.dim.2:                     ; preds = %tanh.2.clone.loop_header.dim.2
  %5 = getelementptr inbounds [32 x [512 x [4096 x float]]], ptr %arg0, i64 0, i64 %tanh.2.clone.indvar.dim.0, i64 %tanh.2.clone.indvar.dim.1, i64 %tanh.2.clone.indvar.dim.2
  %6 = load float, ptr %5, align 4, !invariant.load !1, !noalias !4
  %7 = call float @tanhf(float %6)
  %8 = getelementptr inbounds [32 x [512 x [4096 x float]]], ptr %arg1, i64 0, i64 %tanh.2.clone.indvar.dim.0, i64 %tanh.2.clone.indvar.dim.1, i64 %tanh.2.clone.indvar.dim.2
  store float %7, ptr %8, align 4, !alias.scope !4
  %invar.inc4 = add nuw nsw i64 %tanh.2.clone.indvar.dim.2, 1
  store i64 %invar.inc4, ptr %tanh.2.clone.invar_address.dim.2, align 4
  br label %tanh.2.clone.loop_header.dim.2

tanh.2.clone.loop_exit.dim.2:                     ; preds = %tanh.2.clone.loop_header.dim.2
  %invar.inc3 = add nuw nsw i64 %tanh.2.clone.indvar.dim.1, 1
  store i64 %invar.inc3, ptr %tanh.2.clone.invar_address.dim.1, align 4
  br label %tanh.2.clone.loop_header.dim.1, !llvm.loop !7
...
tanh.2.clone.loop_exit.dim.1:                     ; preds = %tanh.2.clone.loop_header.dim.1
  ...
  br label %tanh.2.clone.loop_header.dim.0, !llvm.loop !9
