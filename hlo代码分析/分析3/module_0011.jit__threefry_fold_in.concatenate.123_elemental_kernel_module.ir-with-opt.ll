...
define noalias noundef ptr @concatenate.123_kernel(ptr readonly captures(none) %0) local_unnamed_addr #0 {
return:
  ...
  %3 = load i32, ptr %arg1, align 64, !invariant.load !1, !noalias !5
