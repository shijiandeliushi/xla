...
transpose_copy_fusion.clone.loop_header.dim.1:    ; preds = %transpose_copy_fusion.clone.loop_exit.dim.2, %transpose_copy_fusion.clone.loop_body.dim.0
  ...
  %3 = icmp uge i64 %transpose_copy_fusion.clone.indvar.dim.1, 512
...
transpose_copy_fusion.clone.loop_header.dim.2:    ; preds = %transpose_copy_fusion.clone.loop_exit.dim.3, %transpose_copy_fusion.clone.loop_body.dim.1
  ...
  %4 = icmp uge i64 %transpose_copy_fusion.clone.indvar.dim.2, 16
...
transpose_copy_fusion.clone.loop_body.dim.3:      ; preds = %transpose_copy_fusion.clone.loop_header.dim.3
  %6 = getelementptr inbounds [32 x [16 x [512 x [64 x float]]]], ptr %arg0, i64 0, i64 %transpose_copy_fusion.clone.indvar.dim.0, i64 %transpose_copy_fusion.clone.indvar.dim.2, i64 %transpose_copy_fusion.clone.indvar.dim.1, i64 %transpose_copy_fusion.clone.indvar.dim.3
  %7 = load float, ptr %6, align 4, !invariant.load !1, !noalias !4
  %8 = getelementptr inbounds [32 x [512 x [16 x [64 x float]]]], ptr %arg1, i64 0, i64 %transpose_copy_fusion.clone.indvar.dim.0, i64 %transpose_copy_fusion.clone.indvar.dim.1, i64 %transpose_copy_fusion.clone.indvar.dim.2, i64 %transpose_copy_fusion.clone.indvar.dim.3
