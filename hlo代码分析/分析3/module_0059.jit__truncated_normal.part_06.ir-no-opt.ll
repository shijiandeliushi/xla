...
@broadcast_add_fusion.clone_parallel_bounds = private constant [12 x [1 x [2 x i64]]] [[1 x [2 x i64]] [[2 x i64] [i64 0, i64 85]], [1 x [2 x i64]] [[2 x i64] [i64 85, i64 170]], [1 x [2 x i64]] [[2 x i64] [i64 170, i64 255]], [1 x [2 x i64]] [[2 x i64] [i64 255, i64 340]], [1 x [2 x i64]] [[2 x i64] [i64 340, i64 425]], [1 x [2 x i64]] [[2 x i64] [i64 425, i64 510]], [1 x [2 x i64]] [[2 x i64] [i64 510, i64 595]], [1 x [2 x i64]] [[2 x i64] [i64 595, i64 680]], [1 x [2 x i64]] [[2 x i64] [i64 680, i64 765]], [1 x [2 x i64]] [[2 x i64] [i64 765, i64 850]], [1 x [2 x i64]] [[2 x i64] [i64 850, i64 935]], [1 x [2 x i64]] [[2 x i64] [i64 935, i64 1024]]]
...
broadcast_add_fusion.clone.loop_header.dim.1:     ; preds = %broadcast_add_fusion.clone.loop_body.dim.1, %broadcast_add_fusion.clone.loop_body.dim.0
  ...
  %3 = icmp uge i64 %broadcast_add_fusion.clone.indvar.dim.1, 4096
...
broadcast_add_fusion.clone.loop_body.dim.1:       ; preds = %broadcast_add_fusion.clone.loop_header.dim.1
  %4 = getelementptr inbounds [1024 x [4096 x i32]], ptr %arg3, i64 0, i64 %broadcast_add_fusion.clone.indvar.dim.0, i64 %broadcast_add_fusion.clone.indvar.dim.1
  %5 = load i32, ptr %4, align 4, !invariant.load !1, !noalias !6
  %6 = getelementptr inbounds [1024 x [4096 x i32]], ptr %arg2, i64 0, i64 %broadcast_add_fusion.clone.indvar.dim.0, i64 %broadcast_add_fusion.clone.indvar.dim.1
  %7 = load i32, ptr %6, align 4, !invariant.load !1, !noalias !6
  %8 = add i32 %5, %7
  %9 = getelementptr inbounds [1024 x [4096 x i32]], ptr %arg2, i64 0, i64 %broadcast_add_fusion.clone.indvar.dim.0, i64 %broadcast_add_fusion.clone.indvar.dim.1
  ...
  %15 = getelementptr inbounds [1024 x [4096 x i32]], ptr %arg2, i64 0, i64 %broadcast_add_fusion.clone.indvar.dim.0, i64 %broadcast_add_fusion.clone.indvar.dim.1
  ...
  %56 = add i32 %53, %55
  %57 = getelementptr inbounds [1024 x [4096 x i32]], ptr %arg5, i64 0, i64 %broadcast_add_fusion.clone.indvar.dim.0, i64 %broadcast_add_fusion.clone.indvar.dim.1
