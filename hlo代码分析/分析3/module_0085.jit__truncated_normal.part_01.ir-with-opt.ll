...
@broadcast_add_fusion.2.clone_parallel_bounds = private unnamed_addr constant [4 x [1 x [2 x i64]]] [[1 x [2 x i64]] [[2 x i64] [i64 0, i64 1024]], [1 x [2 x i64]] [[2 x i64] [i64 1024, i64 2048]], [1 x [2 x i64]] [[2 x i64] [i64 2048, i64 3072]], [1 x [2 x i64]] [[2 x i64] [i64 3072, i64 4096]]]
...
vector.ph:                                        ; preds = %broadcast_add_fusion.2.clone.loop_exit.dim.1, %broadcast_add_fusion.2.clone.loop_header.dim.1.preheader.lr.ph
  ...
  %4 = shl i64 %broadcast_add_fusion.2.clone.invar_address.dim.0.03, 10
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %14 = getelementptr inbounds [4096 x [1024 x i32]], ptr %arg1, i64 0, i64 %broadcast_add_fusion.2.clone.invar_address.dim.0.03, i64 %index
  ...
  %26 = getelementptr inbounds [4096 x [1024 x i32]], ptr %arg1, i64 0, i64 %broadcast_add_fusion.2.clone.invar_address.dim.0.03, i64 %index.next
  ...
  %30 = icmp eq i64 %index.next.1, 1024
