...
@multiply_bitcast_fusion.5.clone_parallel_bounds = private unnamed_addr constant [12 x [1 x [2 x i64]]] [[1 x [2 x i64]] [[2 x i64] [i64 0, i64 1365]], [1 x [2 x i64]] [[2 x i64] [i64 1365, i64 2730]], [1 x [2 x i64]] [[2 x i64] [i64 2730, i64 4095]], [1 x [2 x i64]] [[2 x i64] [i64 4095, i64 5460]], [1 x [2 x i64]] [[2 x i64] [i64 5460, i64 6825]], [1 x [2 x i64]] [[2 x i64] [i64 6825, i64 8190]], [1 x [2 x i64]] [[2 x i64] [i64 8190, i64 9555]], [1 x [2 x i64]] [[2 x i64] [i64 9555, i64 10920]], [1 x [2 x i64]] [[2 x i64] [i64 10920, i64 12285]], [1 x [2 x i64]] [[2 x i64] [i64 12285, i64 13650]], [1 x [2 x i64]] [[2 x i64] [i64 13650, i64 15015]], [1 x [2 x i64]] [[2 x i64] [i64 15015, i64 16384]]]

; Function Attrs: nofree norecurse nosync nounwind memory(readwrite, inaccessiblemem: none) uwtable
define noalias noundef ptr @multiply_bitcast_fusion.5.clone(ptr readonly captures(none) %0) local_unnamed_addr #0 {
  ...
  %lo_dim_0_gep = getelementptr inbounds [12 x [1 x [2 x i64]]], ptr @multiply_bitcast_fusion.5.clone_parallel_bounds, i64 0, i64 %workgroup_id_x, i64 0, i64 0
  %up_dim_0_gep = getelementptr inbounds [12 x [1 x [2 x i64]]], ptr @multiply_bitcast_fusion.5.clone_parallel_bounds, i64 0, i64 %workgroup_id_x, i64 0, i64 1
...
vector.ph:                                        ; preds = %1, %multiply_bitcast_fusion.5.clone.loop_exit.dim.1
  %multiply_bitcast_fusion.5.clone.invar_address.dim.0.03 = phi i64 [ %invar.inc, %multiply_bitcast_fusion.5.clone.loop_exit.dim.1 ], [ %lo_dim_0, %1 ]
  br label %vector.body

vector.body:                                      ; preds = %vector.body, %vector.ph
  %index = phi i64 [ 0, %vector.ph ], [ %index.next, %vector.body ]
  %2 = getelementptr inbounds nuw [16384 x [4096 x float]], ptr %arg1, i64 0, i64 %multiply_bitcast_fusion.5.clone.invar_address.dim.0.03, i64 %index
  ...
  %41 = getelementptr inbounds [16384 x [4096 x float]], ptr %arg2, i64 0, i64 %multiply_bitcast_fusion.5.clone.invar_address.dim.0.03, i64 %index
  store <8 x float> %40, ptr %41, align 32, !alias.scope !5
  %index.next = add nuw i64 %index, 8
  %42 = icmp eq i64 %index.next, 4096
  br i1 %42, label %multiply_bitcast_fusion.5.clone.loop_exit.dim.1, label %vector.body, !llvm.loop !8

multiply_bitcast_fusion.5.clone.loop_exit.dim.1:  ; preds = %vector.body
  %invar.inc = add nuw nsw i64 %multiply_bitcast_fusion.5.clone.invar_address.dim.0.03, 1
  %exitcond4.not = icmp eq i64 %invar.inc, %up_dim_0
  br i1 %exitcond4.not, label %return, label %vector.ph, !llvm.loop !11

return:                                           ; preds = %multiply_bitcast_fusion.5.clone.loop_exit.dim.1, %1
  ret ptr null
}
