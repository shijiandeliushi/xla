...
@multiply_multiply_fusion.clone_parallel_bounds = private constant [4 x [1 x [2 x i64]]] [[1 x [2 x i64]] [[2 x i64] [i64 0, i64 8]], [1 x [2 x i64]] [[2 x i64] [i64 8, i64 16]], [1 x [2 x i64]] [[2 x i64] [i64 16, i64 24]], [1 x [2 x i64]] [[2 x i64] [i64 24, i64 32]]]

; Function Attrs: uwtable
define ptr @multiply_multiply_fusion.clone(ptr %0) #0 {
  %multiply_multiply_fusion.clone.invar_address.dim.2 = alloca i64, align 8
  ...
  %lo_dim_0_gep = getelementptr inbounds [4 x [1 x [2 x i64]]], ptr @multiply_multiply_fusion.clone_parallel_bounds, i32 0, i64 %workgroup_id_x, i32 0, i32 0
  %up_dim_0_gep = getelementptr inbounds [4 x [1 x [2 x i64]]], ptr @multiply_multiply_fusion.clone_parallel_bounds, i32 0, i64 %workgroup_id_x, i32 0, i32 1
...
multiply_multiply_fusion.clone.loop_header.dim.1: ; preds = %multiply_multiply_fusion.clone.loop_exit.dim.2, %multiply_multiply_fusion.clone.loop_body.dim.0
  %multiply_multiply_fusion.clone.indvar.dim.1 = load i64, ptr %multiply_multiply_fusion.clone.invar_address.dim.1, align 4
  %3 = icmp uge i64 %multiply_multiply_fusion.clone.indvar.dim.1, 512
...
multiply_multiply_fusion.clone.loop_body.dim.1:   ; preds = %multiply_multiply_fusion.clone.loop_header.dim.1
  store i64 0, ptr %multiply_multiply_fusion.clone.invar_address.dim.2, align 4
  br label %multiply_multiply_fusion.clone.loop_header.dim.2

multiply_multiply_fusion.clone.loop_header.dim.2: ; preds = %multiply_multiply_fusion.clone.loop_body.dim.2, %multiply_multiply_fusion.clone.loop_body.dim.1
  %multiply_multiply_fusion.clone.indvar.dim.2 = load i64, ptr %multiply_multiply_fusion.clone.invar_address.dim.2, align 4
  %4 = icmp uge i64 %multiply_multiply_fusion.clone.indvar.dim.2, 4096
  br i1 %4, label %multiply_multiply_fusion.clone.loop_exit.dim.2, label %multiply_multiply_fusion.clone.loop_body.dim.2

multiply_multiply_fusion.clone.loop_body.dim.2:   ; preds = %multiply_multiply_fusion.clone.loop_header.dim.2
  %5 = getelementptr inbounds [32 x [512 x [4096 x float]]], ptr %arg0, i64 0, i64 %multiply_multiply_fusion.clone.indvar.dim.0, i64 %multiply_multiply_fusion.clone.indvar.dim.1, i64 %multiply_multiply_fusion.clone.indvar.dim.2
  %6 = load float, ptr %5, align 4, !invariant.load !1, !noalias !4
  %7 = getelementptr inbounds [32 x [512 x [4096 x float]]], ptr %arg0, i64 0, i64 %multiply_multiply_fusion.clone.indvar.dim.0, i64 %multiply_multiply_fusion.clone.indvar.dim.1, i64 %multiply_multiply_fusion.clone.indvar.dim.2
  %8 = load float, ptr %7, align 4, !invariant.load !1, !noalias !4
  %multiply.5 = fmul float %6, %8
  %9 = getelementptr inbounds [32 x [512 x [4096 x float]]], ptr %arg0, i64 0, i64 %multiply_multiply_fusion.clone.indvar.dim.0, i64 %multiply_multiply_fusion.clone.indvar.dim.1, i64 %multiply_multiply_fusion.clone.indvar.dim.2
  %10 = load float, ptr %9, align 4, !invariant.load !1, !noalias !4
  %multiply.4 = fmul float %multiply.5, %10
  %11 = getelementptr inbounds [32 x [512 x [4096 x float]]], ptr %arg1, i64 0, i64 %multiply_multiply_fusion.clone.indvar.dim.0, i64 %multiply_multiply_fusion.clone.indvar.dim.1, i64 %multiply_multiply_fusion.clone.indvar.dim.2
  store float %multiply.4, ptr %11, align 4, !alias.scope !4
  %invar.inc4 = add nuw nsw i64 %multiply_multiply_fusion.clone.indvar.dim.2, 1
  store i64 %invar.inc4, ptr %multiply_multiply_fusion.clone.invar_address.dim.2, align 4
  br label %multiply_multiply_fusion.clone.loop_header.dim.2

multiply_multiply_fusion.clone.loop_exit.dim.2:   ; preds = %multiply_multiply_fusion.clone.loop_header.dim.2
  %invar.inc3 = add nuw nsw i64 %multiply_multiply_fusion.clone.indvar.dim.1, 1
  store i64 %invar.inc3, ptr %multiply_multiply_fusion.clone.invar_address.dim.1, align 4
  br label %multiply_multiply_fusion.clone.loop_header.dim.1, !llvm.loop !7
...
multiply_multiply_fusion.clone.loop_exit.dim.1:   ; preds = %multiply_multiply_fusion.clone.loop_header.dim.1
  ...
  br label %multiply_multiply_fusion.clone.loop_header.dim.0, !llvm.loop !9
