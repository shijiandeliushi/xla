...
broadcast.2.loop_header.dim.0:                    ; preds = %broadcast.2.loop_body.dim.0, %1
  %broadcast.2.indvar.dim.0 = load i64, ptr %broadcast.2.invar_address.dim.0, align 4
  %2 = icmp uge i64 %broadcast.2.indvar.dim.0, 4096
...
broadcast.2.loop_body.dim.0:                      ; preds = %broadcast.2.loop_header.dim.0
  %3 = load float, ptr %arg0, align 4, !invariant.load !1, !noalias !5
  %4 = getelementptr inbounds [4096 x float], ptr %arg1, i64 0, i64 %broadcast.2.indvar.dim.0
  store float %3, ptr %4, align 4, !alias.scope !5
