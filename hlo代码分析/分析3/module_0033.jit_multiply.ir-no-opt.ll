...
@broadcast_multiply_fusion.clone_parallel_bounds = private constant [4 x [1 x [2 x i64]]] [[1 x [2 x i64]] [[2 x i64] [i64 0, i64 128]], [1 x [2 x i64]] [[2 x i64] [i64 128, i64 256]], [1 x [2 x i64]] [[2 x i64] [i64 256, i64 384]], [1 x [2 x i64]] [[2 x i64] [i64 384, i64 512]]]
...
broadcast_multiply_fusion.clone.loop_header.dim.1: ; preds = %broadcast_multiply_fusion.clone.loop_body.dim.1, %broadcast_multiply_fusion.clone.loop_body.dim.0
  ...
  %3 = icmp uge i64 %broadcast_multiply_fusion.clone.indvar.dim.1, 256
...
broadcast_multiply_fusion.clone.loop_body.dim.1:  ; preds = %broadcast_multiply_fusion.clone.loop_header.dim.1
  %4 = getelementptr inbounds [512 x [256 x float]], ptr %arg0, i64 0, i64 %broadcast_multiply_fusion.clone.indvar.dim.0, i64 %broadcast_multiply_fusion.clone.indvar.dim.1
  ...
  %7 = getelementptr inbounds [512 x [256 x float]], ptr %arg2, i64 0, i64 %broadcast_multiply_fusion.clone.indvar.dim.0, i64 %broadcast_multiply_fusion.clone.indvar.dim.1
