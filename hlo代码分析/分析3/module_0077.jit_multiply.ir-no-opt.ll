...
broadcast_multiply_fusion.clone.loop_header.dim.1: ; preds = %broadcast_multiply_fusion.clone.loop_exit.dim.2, %broadcast_multiply_fusion.clone.loop_body.dim.0
  ...
  %3 = icmp uge i64 %broadcast_multiply_fusion.clone.indvar.dim.1, 512
...
broadcast_multiply_fusion.clone.loop_header.dim.2: ; preds = %broadcast_multiply_fusion.clone.loop_body.dim.2, %broadcast_multiply_fusion.clone.loop_body.dim.1
  ...
  %4 = icmp uge i64 %broadcast_multiply_fusion.clone.indvar.dim.2, 4096
...
broadcast_multiply_fusion.clone.loop_body.dim.2:  ; preds = %broadcast_multiply_fusion.clone.loop_header.dim.2
  ...
  %6 = getelementptr inbounds [32 x [512 x [4096 x float]]], ptr %arg0, i64 0, i64 %broadcast_multiply_fusion.clone.indvar.dim.0, i64 %broadcast_multiply_fusion.clone.indvar.dim.1, i64 %broadcast_multiply_fusion.clone.indvar.dim.2
  %7 = load float, ptr %6, align 4, !invariant.load !1, !noalias !5
  %multiply.1 = fmul float %5, %7
  %8 = getelementptr inbounds [32 x [512 x [4096 x float]]], ptr %arg2, i64 0, i64 %broadcast_multiply_fusion.clone.indvar.dim.0, i64 %broadcast_multiply_fusion.clone.indvar.dim.1, i64 %broadcast_multiply_fusion.clone.indvar.dim.2
  store float %multiply.1, ptr %8, align 4, !alias.scope !5
...
broadcast_multiply_fusion.clone.loop_exit.dim.2:  ; preds = %broadcast_multiply_fusion.clone.loop_header.dim.2
  ...
  br label %broadcast_multiply_fusion.clone.loop_header.dim.1, !llvm.loop !8
...
broadcast_multiply_fusion.clone.loop_exit.dim.1:  ; preds = %broadcast_multiply_fusion.clone.loop_header.dim.1
  ...
  br label %broadcast_multiply_fusion.clone.loop_header.dim.0, !llvm.loop !10
