; ModuleID = '__compute_module_concatenate.123_elemental_kernel_module'
source_filename = "__compute_module_concatenate.123_elemental_kernel_module"
...
define ptr @concatenate.123_kernel(ptr %0) #0 {
  ...
  %3 = load i32, ptr %src_addr, align 4, !invariant.load !1, !noalias !5
  store i32 %3, ptr %2, align 4, !alias.scope !5
  %src_addr5 = getelementptr inbounds [1 x i32], ptr %arg1, i64 0, i64 0
  %4 = getelementptr i8, ptr %target_region, i64 4
  %5 = load i32, ptr %src_addr5, align 4, !invariant.load !1, !noalias !5
  store i32 %5, ptr %4, align 4, !alias.scope !5
  br label %return
...
!7 = !{!"XLA host kernel concatenate.123_kernel AA domain"}
