...
define ptr @divide.3_kernel(ptr %0) #0 {
  ...
  %2 = load float, ptr %arg0, align 4, !invariant.load !1, !noalias !4
  %3 = load float, ptr %arg1, align 4, !invariant.load !1, !noalias !4
  %divide.3 = fdiv float %2, %3
  store float %divide.3, ptr %arg2, align 4, !alias.scope !4
  br label %return
