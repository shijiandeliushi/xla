...
broadcast_divide_fusion.clone.loop_body.dim.3:    ; preds = %broadcast_divide_fusion.clone.loop_header.dim.3
  ...
  %8 = getelementptr inbounds [32 x [16 x [512 x [1 x float]]]], ptr %arg1, i64 0, i64 %broadcast_divide_fusion.clone.indvar.dim.0, i64 %broadcast_divide_fusion.clone.indvar.dim.1, i64 %broadcast_divide_fusion.clone.indvar.dim.2, i64 0
  %9 = load float, ptr %8, align 4, !invariant.load !1, !noalias !5
  %divide.1 = fdiv float %7, %9
  ...
  store float %divide.1, ptr %10, align 4, !alias.scope !5
