...
@__llvmsplit_unnamed.10 = private unnamed_addr constant [4 x i8] c"\F3\045?"
...
define ptr @multiply_erf_fusion(ptr %0) #1 {
  ...
  %constant.124 = load float, ptr @__llvmsplit_unnamed.10, align 4
  %multiply.22 = fmul float %3, %constant.124
  %4 = call float @llvm.fabs.f32(float %multiply.22)
  %5 = fcmp ole float 0x400EA8F960000000, %4
  %6 = fmul float %multiply.22, %multiply.22
  ...
  %18 = call float @llvm.copysign.f32(float 1.000000e+00, float %multiply.22)
  %19 = fdiv float %11, %17
...
!3 = !{i64 64}
!4 = !{!5}
!5 = !{!"result slice: {index:9, offset:50331968, size:4}", !6}
