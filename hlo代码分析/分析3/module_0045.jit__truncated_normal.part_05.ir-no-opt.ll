...
@broadcast_add_fusion.1.clone_parallel_bounds = private constant [12 x [1 x [2 x i64]]] [[1 x [2 x i64]] [[2 x i64] [i64 0, i64 21]], [1 x [2 x i64]] [[2 x i64] [i64 21, i64 42]], [1 x [2 x i64]] [[2 x i64] [i64 42, i64 63]], [1 x [2 x i64]] [[2 x i64] [i64 63, i64 84]], [1 x [2 x i64]] [[2 x i64] [i64 84, i64 105]], [1 x [2 x i64]] [[2 x i64] [i64 105, i64 126]], [1 x [2 x i64]] [[2 x i64] [i64 126, i64 147]], [1 x [2 x i64]] [[2 x i64] [i64 147, i64 168]], [1 x [2 x i64]] [[2 x i64] [i64 168, i64 189]], [1 x [2 x i64]] [[2 x i64] [i64 189, i64 210]], [1 x [2 x i64]] [[2 x i64] [i64 210, i64 231]], [1 x [2 x i64]] [[2 x i64] [i64 231, i64 256]]]
...
broadcast_add_fusion.1.clone.loop_header.dim.1:   ; preds = %broadcast_add_fusion.1.clone.loop_body.dim.1, %broadcast_add_fusion.1.clone.loop_body.dim.0
  ...
  %3 = icmp uge i64 %broadcast_add_fusion.1.clone.indvar.dim.1, 128
...
broadcast_add_fusion.1.clone.loop_body.dim.1:     ; preds = %broadcast_add_fusion.1.clone.loop_header.dim.1
  %4 = getelementptr inbounds [256 x [128 x i32]], ptr %arg3, i64 0, i64 %broadcast_add_fusion.1.clone.indvar.dim.0, i64 %broadcast_add_fusion.1.clone.indvar.dim.1
  %5 = load i32, ptr %4, align 4, !invariant.load !1, !noalias !6
  %6 = getelementptr inbounds [256 x [128 x i32]], ptr %arg2, i64 0, i64 %broadcast_add_fusion.1.clone.indvar.dim.0, i64 %broadcast_add_fusion.1.clone.indvar.dim.1
  %7 = load i32, ptr %6, align 4, !invariant.load !1, !noalias !6
  %8 = add i32 %5, %7
  %9 = getelementptr inbounds [256 x [128 x i32]], ptr %arg2, i64 0, i64 %broadcast_add_fusion.1.clone.indvar.dim.0, i64 %broadcast_add_fusion.1.clone.indvar.dim.1
  ...
  %15 = getelementptr inbounds [256 x [128 x i32]], ptr %arg2, i64 0, i64 %broadcast_add_fusion.1.clone.indvar.dim.0, i64 %broadcast_add_fusion.1.clone.indvar.dim.1
  ...
  %44 = add i32 %42, %43
  %45 = getelementptr inbounds [256 x [128 x i32]], ptr %arg4, i64 0, i64 %broadcast_add_fusion.1.clone.indvar.dim.0, i64 %broadcast_add_fusion.1.clone.indvar.dim.1
