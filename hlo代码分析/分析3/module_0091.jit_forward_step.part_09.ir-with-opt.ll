...
@subtract_exponential_fusion.clone_parallel_bounds = private unnamed_addr constant [4 x [1 x [2 x i64]]] [[1 x [2 x i64]] [[2 x i64] [i64 0, i64 8]], [1 x [2 x i64]] [[2 x i64] [i64 8, i64 16]], [1 x [2 x i64]] [[2 x i64] [i64 16, i64 24]], [1 x [2 x i64]] [[2 x i64] [i64 24, i64 32]]]

; Function Attrs: nofree norecurse nosync nounwind memory(readwrite, inaccessiblemem: none) uwtable
define noalias noundef ptr @add_add_fusion.10.clone(ptr readonly captures(none) %0) local_unnamed_addr #0 {
  ...
  %lo_dim_0_gep = getelementptr inbounds [4 x [1 x [2 x i64]]], ptr @subtract_exponential_fusion.clone_parallel_bounds, i64 0, i64 %workgroup_id_x, i64 0, i64 0
  %up_dim_0_gep = getelementptr inbounds [4 x [1 x [2 x i64]]], ptr @subtract_exponential_fusion.clone_parallel_bounds, i64 0, i64 %workgroup_id_x, i64 0, i64 1
  %lo_dim_0 = load i64, ptr %lo_dim_0_gep, align 16
  %up_dim_0 = load i64, ptr %up_dim_0_gep, align 8
  %.not3 = icmp ult i64 %lo_dim_0, %up_dim_0
  br i1 %.not3, label %add_add_fusion.10.clone.loop_header.dim.1.preheader, label %return

add_add_fusion.10.clone.loop_header.dim.1.preheader: ; preds = %1, %add_add_fusion.10.clone.loop_exit.dim.1
  %add_add_fusion.10.clone.invar_address.dim.0.04 = phi i64 [ %invar.inc, %add_add_fusion.10.clone.loop_exit.dim.1 ], [ %lo_dim_0, %1 ]
  %2 = shl nuw nsw i64 %add_add_fusion.10.clone.invar_address.dim.0.04, 9
  br label %add_add_fusion.10.clone.loop_header.dim.2.preheader

add_add_fusion.10.clone.loop_header.dim.2.preheader: ; preds = %add_add_fusion.10.clone.loop_header.dim.1.preheader, %add_add_fusion.10.clone.loop_exit.dim.2
  %add_add_fusion.10.clone.invar_address.dim.1.02 = phi i64 [ 0, %add_add_fusion.10.clone.loop_header.dim.1.preheader ], [ %invar.inc7, %add_add_fusion.10.clone.loop_exit.dim.2 ]
  %3 = add nuw nsw i64 %add_add_fusion.10.clone.invar_address.dim.1.02, %2
  br label %vector.body

vector.body:                                      ; preds = %vector.body, %add_add_fusion.10.clone.loop_header.dim.2.preheader
  %index = phi i64 [ 0, %add_add_fusion.10.clone.loop_header.dim.2.preheader ], [ %index.next.3, %vector.body ]
  %4 = getelementptr inbounds [32 x [512 x [1024 x float]]], ptr %arg0, i64 0, i64 %add_add_fusion.10.clone.invar_address.dim.0.04, i64 %add_add_fusion.10.clone.invar_address.dim.1.02, i64 %index
  ...
  %14 = getelementptr inbounds [32 x [512 x [1024 x float]]], ptr %arg3, i64 0, i64 %add_add_fusion.10.clone.invar_address.dim.0.04, i64 %add_add_fusion.10.clone.invar_address.dim.1.02, i64 %index
  ...
  %16 = getelementptr inbounds [32 x [512 x [1024 x float]]], ptr %arg0, i64 0, i64 %add_add_fusion.10.clone.invar_address.dim.0.04, i64 %add_add_fusion.10.clone.invar_address.dim.1.02, i64 %index.next
  ...
  %26 = getelementptr inbounds [32 x [512 x [1024 x float]]], ptr %arg3, i64 0, i64 %add_add_fusion.10.clone.invar_address.dim.0.04, i64 %add_add_fusion.10.clone.invar_address.dim.1.02, i64 %index.next
  ...
  %28 = getelementptr inbounds [32 x [512 x [1024 x float]]], ptr %arg0, i64 0, i64 %add_add_fusion.10.clone.invar_address.dim.0.04, i64 %add_add_fusion.10.clone.invar_address.dim.1.02, i64 %index.next.1
  ...
  %38 = getelementptr inbounds [32 x [512 x [1024 x float]]], ptr %arg3, i64 0, i64 %add_add_fusion.10.clone.invar_address.dim.0.04, i64 %add_add_fusion.10.clone.invar_address.dim.1.02, i64 %index.next.1
  ...
  %40 = getelementptr inbounds [32 x [512 x [1024 x float]]], ptr %arg0, i64 0, i64 %add_add_fusion.10.clone.invar_address.dim.0.04, i64 %add_add_fusion.10.clone.invar_address.dim.1.02, i64 %index.next.2
  ...
  %50 = getelementptr inbounds [32 x [512 x [1024 x float]]], ptr %arg3, i64 0, i64 %add_add_fusion.10.clone.invar_address.dim.0.04, i64 %add_add_fusion.10.clone.invar_address.dim.1.02, i64 %index.next.2
  ...
  br i1 %52, label %add_add_fusion.10.clone.loop_exit.dim.2, label %vector.body, !llvm.loop !8

add_add_fusion.10.clone.loop_exit.dim.2:          ; preds = %vector.body
  %invar.inc7 = add nuw nsw i64 %add_add_fusion.10.clone.invar_address.dim.1.02, 1
  %exitcond5 = icmp eq i64 %invar.inc7, 512
  br i1 %exitcond5, label %add_add_fusion.10.clone.loop_exit.dim.1, label %add_add_fusion.10.clone.loop_header.dim.2.preheader, !llvm.loop !11

add_add_fusion.10.clone.loop_exit.dim.1:          ; preds = %add_add_fusion.10.clone.loop_exit.dim.2
  %invar.inc = add nuw nsw i64 %add_add_fusion.10.clone.invar_address.dim.0.04, 1
  %exitcond6.not = icmp eq i64 %invar.inc, %up_dim_0
  br i1 %exitcond6.not, label %return, label %add_add_fusion.10.clone.loop_header.dim.1.preheader, !llvm.loop !13

return:                                           ; preds = %add_add_fusion.10.clone.loop_exit.dim.1, %1
  ret ptr null
}

; Function Attrs: nofree norecurse nosync nounwind memory(readwrite, inaccessiblemem: none) uwtable
define noalias noundef ptr @subtract_exponential_fusion.clone(ptr readonly captures(none) %0) local_unnamed_addr #0 {
  %workgroup_id_gep = getelementptr inbounds nuw i8, ptr %0, i64 8
  %workgroup_id = load ptr, ptr %workgroup_id_gep, align 8
  %workgroup_id_x = load i64, ptr %workgroup_id, align 4
  %args_gep = getelementptr inbounds nuw i8, ptr %0, i64 24
  ...
  br i1 %.not4, label %subtract_exponential_fusion.clone.loop_header.dim.1.preheader, label %return

subtract_exponential_fusion.clone.loop_header.dim.1.preheader: ; preds = %1, %subtract_exponential_fusion.clone.loop_exit.dim.1
  %subtract_exponential_fusion.clone.invar_address.dim.0.05 = phi i64 [ %invar.inc, %subtract_exponential_fusion.clone.loop_exit.dim.1 ], [ %lo_dim_0, %1 ]
  br label %subtract_exponential_fusion.clone.loop_header.dim.2.preheader

subtract_exponential_fusion.clone.loop_header.dim.2.preheader: ; preds = %subtract_exponential_fusion.clone.loop_header.dim.1.preheader, %subtract_exponential_fusion.clone.loop_exit.dim.2
  %subtract_exponential_fusion.clone.invar_address.dim.1.03 = phi i64 [ 0, %subtract_exponential_fusion.clone.loop_header.dim.1.preheader ], [ %invar.inc5, %subtract_exponential_fusion.clone.loop_exit.dim.2 ]
  br label %vector.ph

vector.ph:                                        ; preds = %subtract_exponential_fusion.clone.loop_exit.dim.3, %subtract_exponential_fusion.clone.loop_header.dim.2.preheader
  %subtract_exponential_fusion.clone.invar_address.dim.2.02 = phi i64 [ 0, %subtract_exponential_fusion.clone.loop_header.dim.2.preheader ], [ %invar.inc6, %subtract_exponential_fusion.clone.loop_exit.dim.3 ]
  %2 = getelementptr inbounds [32 x [16 x [512 x float]]], ptr %arg0, i64 0, i64 %subtract_exponential_fusion.clone.invar_address.dim.0.05, i64 %subtract_exponential_fusion.clone.invar_address.dim.1.03, i64 %subtract_exponential_fusion.clone.invar_address.dim.2.02
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %4 = getelementptr inbounds [32 x [16 x [512 x [512 x float]]]], ptr %arg1, i64 0, i64 %subtract_exponential_fusion.clone.invar_address.dim.0.05, i64 %subtract_exponential_fusion.clone.invar_address.dim.1.03, i64 %subtract_exponential_fusion.clone.invar_address.dim.2.02, i64 %index
  %5 = getelementptr inbounds nuw i8, ptr %4, i64 32
  ...
  %76 = getelementptr inbounds [32 x [16 x [512 x [512 x float]]]], ptr %arg2, i64 0, i64 %subtract_exponential_fusion.clone.invar_address.dim.0.05, i64 %subtract_exponential_fusion.clone.invar_address.dim.1.03, i64 %subtract_exponential_fusion.clone.invar_address.dim.2.02, i64 %index
  ...
  br i1 %80, label %subtract_exponential_fusion.clone.loop_exit.dim.3, label %vector.body, !llvm.loop !19

subtract_exponential_fusion.clone.loop_exit.dim.3: ; preds = %vector.body
  %invar.inc6 = add nuw nsw i64 %subtract_exponential_fusion.clone.invar_address.dim.2.02, 1
  %exitcond6 = icmp eq i64 %invar.inc6, 512
  br i1 %exitcond6, label %subtract_exponential_fusion.clone.loop_exit.dim.2, label %vector.ph, !llvm.loop !20

subtract_exponential_fusion.clone.loop_exit.dim.2: ; preds = %subtract_exponential_fusion.clone.loop_exit.dim.3
  %invar.inc5 = add nuw nsw i64 %subtract_exponential_fusion.clone.invar_address.dim.1.03, 1
  %exitcond7 = icmp eq i64 %invar.inc5, 16
  br i1 %exitcond7, label %subtract_exponential_fusion.clone.loop_exit.dim.1, label %subtract_exponential_fusion.clone.loop_header.dim.2.preheader, !llvm.loop !21

subtract_exponential_fusion.clone.loop_exit.dim.1: ; preds = %subtract_exponential_fusion.clone.loop_exit.dim.2
  %invar.inc = add nuw nsw i64 %subtract_exponential_fusion.clone.invar_address.dim.0.05, 1
  %exitcond8.not = icmp eq i64 %invar.inc, %up_dim_0
  br i1 %exitcond8.not, label %return, label %subtract_exponential_fusion.clone.loop_header.dim.1.preheader, !llvm.loop !22

return:                                           ; preds = %subtract_exponential_fusion.clone.loop_exit.dim.1, %1
  ret ptr null
}
...
!18 = !{!"XLA host kernel subtract_exponential_fusion.clone AA domain"}
!19 = distinct !{!19, !9, !10}
!20 = distinct !{!20, !12}
!21 = distinct !{!21, !12}
!22 = distinct !{!22, !12}
