...
@broadcast_add_fusion.clone_parallel_bounds = private constant [12 x [1 x [2 x i64]]] [[1 x [2 x i64]] [[2 x i64] [i64 0, i64 42]], [1 x [2 x i64]] [[2 x i64] [i64 42, i64 84]], [1 x [2 x i64]] [[2 x i64] [i64 84, i64 126]], [1 x [2 x i64]] [[2 x i64] [i64 126, i64 168]], [1 x [2 x i64]] [[2 x i64] [i64 168, i64 210]], [1 x [2 x i64]] [[2 x i64] [i64 210, i64 252]], [1 x [2 x i64]] [[2 x i64] [i64 252, i64 294]], [1 x [2 x i64]] [[2 x i64] [i64 294, i64 336]], [1 x [2 x i64]] [[2 x i64] [i64 336, i64 378]], [1 x [2 x i64]] [[2 x i64] [i64 378, i64 420]], [1 x [2 x i64]] [[2 x i64] [i64 420, i64 462]], [1 x [2 x i64]] [[2 x i64] [i64 462, i64 512]]]
...
broadcast_add_fusion.clone.loop_header.dim.1:     ; preds = %broadcast_add_fusion.clone.loop_body.dim.1, %broadcast_add_fusion.clone.loop_body.dim.0
  ...
  %3 = icmp uge i64 %broadcast_add_fusion.clone.indvar.dim.1, 256
...
broadcast_add_fusion.clone.loop_body.dim.1:       ; preds = %broadcast_add_fusion.clone.loop_header.dim.1
  %4 = getelementptr inbounds [512 x [256 x i32]], ptr %arg3, i64 0, i64 %broadcast_add_fusion.clone.indvar.dim.0, i64 %broadcast_add_fusion.clone.indvar.dim.1
  %5 = load i32, ptr %4, align 4, !invariant.load !1, !noalias !6
  %6 = getelementptr inbounds [512 x [256 x i32]], ptr %arg2, i64 0, i64 %broadcast_add_fusion.clone.indvar.dim.0, i64 %broadcast_add_fusion.clone.indvar.dim.1
  %7 = load i32, ptr %6, align 4, !invariant.load !1, !noalias !6
  %8 = add i32 %5, %7
  %9 = getelementptr inbounds [512 x [256 x i32]], ptr %arg2, i64 0, i64 %broadcast_add_fusion.clone.indvar.dim.0, i64 %broadcast_add_fusion.clone.indvar.dim.1
  ...
  %15 = getelementptr inbounds [512 x [256 x i32]], ptr %arg2, i64 0, i64 %broadcast_add_fusion.clone.indvar.dim.0, i64 %broadcast_add_fusion.clone.indvar.dim.1
  ...
  %56 = add i32 %53, %55
  %57 = getelementptr inbounds [512 x [256 x i32]], ptr %arg5, i64 0, i64 %broadcast_add_fusion.clone.indvar.dim.0, i64 %broadcast_add_fusion.clone.indvar.dim.1
