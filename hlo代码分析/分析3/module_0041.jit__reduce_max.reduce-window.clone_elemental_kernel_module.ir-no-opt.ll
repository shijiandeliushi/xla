...
entry:
  %maximum.6 = alloca float, align 4
  ...
  %2 = load float, ptr %Arg_0.4, align 4, !alias.scope !13, !noalias !16
  %3 = load float, ptr %Arg_1.5, align 4, !alias.scope !18, !noalias !16
  %4 = call reassoc float @llvm.maximum.f32(float %2, float %3)
  store float %4, ptr %maximum.6, align 4, !alias.scope !16
  %load_ret_value = load float, ptr %maximum.6, align 4
...
!5 = !{i64 16777216}
!6 = !{!7}
!7 = !{!"result slice: {index:10, offset:0, size:16777216}", !8}
...
!12 = distinct !{!12, !10}
!13 = !{!14}
!14 = !{!"buffer: {index:8, offset:0, size:4}", !15}
!15 = !{!"XLA global AA domain"}
!16 = !{!17}
!17 = !{!"buffer: {index:4, offset:0, size:4}", !15}
!18 = !{!19}
!19 = !{!"buffer: {index:9, offset:0, size:4}", !15}
