...
@reduce-window.clone_parallel_bounds = private constant [4 x [1 x [2 x i64]]] [[1 x [2 x i64]] [[2 x i64] [i64 0, i64 8]], [1 x [2 x i64]] [[2 x i64] [i64 8, i64 16]], [1 x [2 x i64]] [[2 x i64] [i64 16, i64 24]], [1 x [2 x i64]] [[2 x i64] [i64 24, i64 32]]]
...
define ptr @reduce-window.clone_kernel(ptr %0) #0 {
  ...
  %reduce-window.clone.invar_address.window.3 = alloca i64, align 8
  %reduce-window.clone.invar_address.window.2 = alloca i64, align 8
  ...
  %reduce-window.clone.invar_address.dim.3 = alloca i64, align 8
  %reduce-window.clone.invar_address.dim.2 = alloca i64, align 8
...
reduce-window.clone.loop_body.dim.1:              ; preds = %reduce-window.clone.loop_header.dim.1
  store i64 0, ptr %reduce-window.clone.invar_address.dim.2, align 4
...
reduce-window.clone.loop_header.dim.2:            ; preds = %reduce-window.clone.loop_exit.dim.3, %reduce-window.clone.loop_body.dim.1
  %reduce-window.clone.indvar.dim.2 = load i64, ptr %reduce-window.clone.invar_address.dim.2, align 4
  %4 = icmp uge i64 %reduce-window.clone.indvar.dim.2, 512
  br i1 %4, label %reduce-window.clone.loop_exit.dim.2, label %reduce-window.clone.loop_body.dim.2

reduce-window.clone.loop_body.dim.2:              ; preds = %reduce-window.clone.loop_header.dim.2
  store i64 0, ptr %reduce-window.clone.invar_address.dim.3, align 4
  br label %reduce-window.clone.loop_header.dim.3

reduce-window.clone.loop_header.dim.3:            ; preds = %reduce-window.clone.loop_exit.window.0, %reduce-window.clone.loop_body.dim.2
  %reduce-window.clone.indvar.dim.3 = load i64, ptr %reduce-window.clone.invar_address.dim.3, align 4
  %5 = icmp uge i64 %reduce-window.clone.indvar.dim.3, 16
  br i1 %5, label %reduce-window.clone.loop_exit.dim.3, label %reduce-window.clone.loop_body.dim.3
...
reduce-window.clone.loop_header.window.0:         ; preds = %reduce-window.clone.loop_exit.window.1, %reduce-window.clone.loop_body.dim.3
  %reduce-window.clone.indvar.window.0 = load i64, ptr %reduce-window.clone.invar_address.window.0, align 4
  %7 = icmp uge i64 %reduce-window.clone.indvar.window.0, 1
  br i1 %7, label %reduce-window.clone.loop_exit.window.0, label %reduce-window.clone.loop_body.window.0
...
reduce-window.clone.loop_header.window.1:         ; preds = %reduce-window.clone.loop_exit.window.2, %reduce-window.clone.loop_body.window.0
  %reduce-window.clone.indvar.window.1 = load i64, ptr %reduce-window.clone.invar_address.window.1, align 4
  %8 = icmp uge i64 %reduce-window.clone.indvar.window.1, 1
  br i1 %8, label %reduce-window.clone.loop_exit.window.1, label %reduce-window.clone.loop_body.window.1

reduce-window.clone.loop_body.window.1:           ; preds = %reduce-window.clone.loop_header.window.1
  store i64 0, ptr %reduce-window.clone.invar_address.window.2, align 4
  br label %reduce-window.clone.loop_header.window.2

reduce-window.clone.loop_header.window.2:         ; preds = %reduce-window.clone.loop_exit.window.3, %reduce-window.clone.loop_body.window.1
  %reduce-window.clone.indvar.window.2 = load i64, ptr %reduce-window.clone.invar_address.window.2, align 4
  %9 = icmp uge i64 %reduce-window.clone.indvar.window.2, 1
  br i1 %9, label %reduce-window.clone.loop_exit.window.2, label %reduce-window.clone.loop_body.window.2

reduce-window.clone.loop_body.window.2:           ; preds = %reduce-window.clone.loop_header.window.2
  store i64 0, ptr %reduce-window.clone.invar_address.window.3, align 4
  br label %reduce-window.clone.loop_header.window.3

reduce-window.clone.loop_header.window.3:         ; preds = %in_bounds-after, %reduce-window.clone.loop_body.window.2
  %reduce-window.clone.indvar.window.3 = load i64, ptr %reduce-window.clone.invar_address.window.3, align 4
  %10 = icmp uge i64 %reduce-window.clone.indvar.window.3, 32
  br i1 %10, label %reduce-window.clone.loop_exit.window.3, label %reduce-window.clone.loop_body.window.3

reduce-window.clone.loop_body.window.3:           ; preds = %reduce-window.clone.loop_header.window.3
  %11 = mul nsw i64 %reduce-window.clone.indvar.dim.0, 1
  %12 = mul nsw i64 %reduce-window.clone.indvar.window.0, 1
  ...
  %20 = and i1 %17, %19
  %21 = mul nsw i64 %reduce-window.clone.indvar.dim.1, 1
  %22 = mul nsw i64 %reduce-window.clone.indvar.window.1, 1
  ...
  %30 = and i1 %27, %29
  %31 = mul nsw i64 %reduce-window.clone.indvar.dim.2, 1
  %32 = mul nsw i64 %reduce-window.clone.indvar.window.2, 1
  ...
  %40 = and i1 %37, %39
  %41 = mul nsw i64 %reduce-window.clone.indvar.dim.3, 32
  %42 = mul nsw i64 %reduce-window.clone.indvar.window.3, 1
...
in_bounds-after:                                  ; preds = %in_bounds-false, %in_bounds-true
  %invar.inc11 = add nuw nsw i64 %reduce-window.clone.indvar.window.3, 1
  store i64 %invar.inc11, ptr %reduce-window.clone.invar_address.window.3, align 4
  br label %reduce-window.clone.loop_header.window.3

reduce-window.clone.loop_exit.window.3:           ; preds = %reduce-window.clone.loop_header.window.3
  %invar.inc10 = add nuw nsw i64 %reduce-window.clone.indvar.window.2, 1
  store i64 %invar.inc10, ptr %reduce-window.clone.invar_address.window.2, align 4
  br label %reduce-window.clone.loop_header.window.2

reduce-window.clone.loop_exit.window.2:           ; preds = %reduce-window.clone.loop_header.window.2
  %invar.inc9 = add nuw nsw i64 %reduce-window.clone.indvar.window.1, 1
  store i64 %invar.inc9, ptr %reduce-window.clone.invar_address.window.1, align 4
  br label %reduce-window.clone.loop_header.window.1

reduce-window.clone.loop_exit.window.1:           ; preds = %reduce-window.clone.loop_header.window.1
  %invar.inc8 = add nuw nsw i64 %reduce-window.clone.indvar.window.0, 1
  store i64 %invar.inc8, ptr %reduce-window.clone.invar_address.window.0, align 4
  br label %reduce-window.clone.loop_header.window.0
...
reduce-window.clone.loop_exit.window.0:           ; preds = %reduce-window.clone.loop_header.window.0
  ...
  %52 = getelementptr inbounds [32 x [16 x [512 x [16 x float]]]], ptr %arg2, i64 0, i64 %reduce-window.clone.indvar.dim.0, i64 %reduce-window.clone.indvar.dim.1, i64 %reduce-window.clone.indvar.dim.2, i64 %reduce-window.clone.indvar.dim.3
  store float %51, ptr %52, align 4, !alias.scope !6
  %invar.inc7 = add nuw nsw i64 %reduce-window.clone.indvar.dim.3, 1
  store i64 %invar.inc7, ptr %reduce-window.clone.invar_address.dim.3, align 4
  br label %reduce-window.clone.loop_header.dim.3

reduce-window.clone.loop_exit.dim.3:              ; preds = %reduce-window.clone.loop_header.dim.3
  %invar.inc6 = add nuw nsw i64 %reduce-window.clone.indvar.dim.2, 1
  store i64 %invar.inc6, ptr %reduce-window.clone.invar_address.dim.2, align 4
  br label %reduce-window.clone.loop_header.dim.2, !llvm.loop !9
...
reduce-window.clone.loop_exit.dim.2:              ; preds = %reduce-window.clone.loop_header.dim.2
  ...
  br label %reduce-window.clone.loop_header.dim.1, !llvm.loop !11
...
reduce-window.clone.loop_exit.dim.1:              ; preds = %reduce-window.clone.loop_header.dim.1
  ...
  br label %reduce-window.clone.loop_header.dim.0, !llvm.loop !12
...
in_bounds-true:                                   ; preds = %reduce-window.clone.loop_body.window.3
  ...
  call void @region_0.6(ptr %reducer_function_return_value_addr, ptr null, ptr %reducer_function_parameter_addresses, ptr null, ptr null, ptr null)
...
in_bounds-false:                                  ; preds = %reduce-window.clone.loop_body.window.3
  br label %in_bounds-after
}

; Function Attrs: alwaysinline uwtable
define internal void @region_0.6(ptr %retval, ptr noalias %run_options, ptr noalias %params, ptr noalias %buffer_table, ptr noalias %status, ptr noalias %prof_counters) #1 {
entry:
  %add.5 = alloca float, align 4
  %0 = getelementptr inbounds ptr, ptr %params, i64 0
  %Arg_0.3 = load ptr, ptr %0, align 8, !dereferenceable !4, !align !4
  %1 = getelementptr inbounds ptr, ptr %params, i64 1
  %Arg_1.4 = load ptr, ptr %1, align 8, !dereferenceable !4, !align !4
  %2 = load float, ptr %Arg_0.3, align 4, !alias.scope !13, !noalias !16
  %3 = load float, ptr %Arg_1.4, align 4, !alias.scope !18, !noalias !16
  %add.51 = fadd reassoc float %2, %3
  store float %add.51, ptr %add.5, align 4, !alias.scope !16
  %load_ret_value = load float, ptr %add.5, align 4
...
!5 = !{i64 16777216}
!6 = !{!7}
!7 = !{!"result slice: {index:9, offset:0, size:16777216}", !8}
...
!12 = distinct !{!12, !10}
!13 = !{!14}
!14 = !{!"buffer: {index:7, offset:0, size:4}", !15}
!15 = !{!"XLA global AA domain"}
!16 = !{!17}
!17 = !{!"buffer: {index:3, offset:0, size:4}", !15}
!18 = !{!19}
!19 = !{!"buffer: {index:8, offset:0, size:4}", !15}
