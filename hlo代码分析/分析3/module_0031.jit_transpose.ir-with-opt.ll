...
vector.ph:                                        ; preds = %vector.ph, %transpose_copy_fusion.clone.loop_header.dim.2.preheader
  ...
  %2 = getelementptr inbounds [32 x [512 x [16 x [64 x float]]]], ptr %arg0, i64 0, i64 %transpose_copy_fusion.clone.invar_address.dim.0.010, i64 %transpose_copy_fusion.clone.invar_address.dim.2.07, i64 %transpose_copy_fusion.clone.invar_address.dim.1.08, i64 0
  ...
  %6 = getelementptr inbounds [32 x [16 x [512 x [64 x float]]]], ptr %arg1, i64 0, i64 %transpose_copy_fusion.clone.invar_address.dim.0.010, i64 %transpose_copy_fusion.clone.invar_address.dim.1.08, i64 %transpose_copy_fusion.clone.invar_address.dim.2.07, i64 0
  ...
  %10 = getelementptr inbounds [32 x [512 x [16 x [64 x float]]]], ptr %arg0, i64 0, i64 %transpose_copy_fusion.clone.invar_address.dim.0.010, i64 %transpose_copy_fusion.clone.invar_address.dim.2.07, i64 %transpose_copy_fusion.clone.invar_address.dim.1.08, i64 32
  ...
  %14 = getelementptr inbounds [32 x [16 x [512 x [64 x float]]]], ptr %arg1, i64 0, i64 %transpose_copy_fusion.clone.invar_address.dim.0.010, i64 %transpose_copy_fusion.clone.invar_address.dim.1.08, i64 %transpose_copy_fusion.clone.invar_address.dim.2.07, i64 32
  ...
  %exitcond12 = icmp eq i64 %invar.inc4, 512
...
transpose_copy_fusion.clone.loop_exit.dim.2:      ; preds = %vector.ph
  ...
  %exitcond13 = icmp eq i64 %invar.inc3, 16
