...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %3 = getelementptr inbounds [1024 x [4096 x float]], ptr %arg0, i64 0, i64 %broadcast_multiply_fusion.clone.invar_address.dim.0.08, i64 %index
  ...
  %11 = getelementptr inbounds [1024 x [4096 x float]], ptr %arg2, i64 0, i64 %broadcast_multiply_fusion.clone.invar_address.dim.0.08, i64 %index
  ...
  %15 = getelementptr inbounds [1024 x [4096 x float]], ptr %arg0, i64 0, i64 %broadcast_multiply_fusion.clone.invar_address.dim.0.08, i64 %index.next
  ...
  %23 = getelementptr inbounds [1024 x [4096 x float]], ptr %arg2, i64 0, i64 %broadcast_multiply_fusion.clone.invar_address.dim.0.08, i64 %index.next
  ...
  %27 = getelementptr inbounds [1024 x [4096 x float]], ptr %arg0, i64 0, i64 %broadcast_multiply_fusion.clone.invar_address.dim.0.08, i64 %index.next.1
  ...
  %35 = getelementptr inbounds [1024 x [4096 x float]], ptr %arg2, i64 0, i64 %broadcast_multiply_fusion.clone.invar_address.dim.0.08, i64 %index.next.1
  ...
  %39 = getelementptr inbounds [1024 x [4096 x float]], ptr %arg0, i64 0, i64 %broadcast_multiply_fusion.clone.invar_address.dim.0.08, i64 %index.next.2
  ...
  %47 = getelementptr inbounds [1024 x [4096 x float]], ptr %arg2, i64 0, i64 %broadcast_multiply_fusion.clone.invar_address.dim.0.08, i64 %index.next.2
