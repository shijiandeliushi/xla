...
define ptr @broadcast_maximum_fusion(ptr %0) #1 {
...
broadcast_maximum_fusion.loop_header.dim.1:       ; preds = %broadcast_maximum_fusion.loop_body.dim.1, %broadcast_maximum_fusion.loop_body.dim.0
  ...
  %3 = icmp uge i64 %broadcast_maximum_fusion.indvar.dim.1, 256
...
broadcast_maximum_fusion.loop_body.dim.1:         ; preds = %broadcast_maximum_fusion.loop_header.dim.1
  %4 = getelementptr inbounds [64 x [256 x float]], ptr %arg0, i64 0, i64 %broadcast_maximum_fusion.indvar.dim.0, i64 %broadcast_maximum_fusion.indvar.dim.1
  %5 = load float, ptr %4, align 4
  %6 = getelementptr inbounds [256 x float], ptr %arg1, i64 0, i64 %broadcast_maximum_fusion.indvar.dim.1
  %7 = load float, ptr %6, align 4, !invariant.load !1, !noalias !5
  %add.1 = fadd float %5, %7
  %constant.2 = load float, ptr @__llvmsplit_unnamed.1, align 4
  %8 = call float @llvm.maximum.f32(float %add.1, float %constant.2)
  %9 = getelementptr inbounds [64 x [256 x float]], ptr %arg2, i64 0, i64 %broadcast_maximum_fusion.indvar.dim.0, i64 %broadcast_maximum_fusion.indvar.dim.1
  store float %8, ptr %9, align 4, !alias.scope !5
  %invar.inc5 = add nuw nsw i64 %broadcast_maximum_fusion.indvar.dim.1, 1
  store i64 %invar.inc5, ptr %broadcast_maximum_fusion.invar_address.dim.1, align 4
  br label %broadcast_maximum_fusion.loop_header.dim.1
...
broadcast_maximum_fusion.loop_exit.dim.1:         ; preds = %broadcast_maximum_fusion.loop_header.dim.1
  ...
  br label %broadcast_maximum_fusion.loop_header.dim.0, !llvm.loop !8
