...
in_bounds-true:                                   ; preds = %reduce-window.clone.loop_body.window.3
  ...
  call void @region_0.117(ptr %reducer_function_return_value_addr, ptr null, ptr %reducer_function_parameter_addresses, ptr null, ptr null, ptr null)
...
define internal void @region_0.117(ptr %retval, ptr noalias %run_options, ptr noalias %params, ptr noalias %buffer_table, ptr noalias %status, ptr noalias %prof_counters) #1 {
entry:
  %maximum.116 = alloca float, align 4
  %0 = getelementptr inbounds ptr, ptr %params, i64 0
  %Arg_0.114 = load ptr, ptr %0, align 8, !dereferenceable !4, !align !4
  %1 = getelementptr inbounds ptr, ptr %params, i64 1
  %Arg_1.115 = load ptr, ptr %1, align 8, !dereferenceable !4, !align !4
  %2 = load float, ptr %Arg_0.114, align 4, !alias.scope !13, !noalias !16
  %3 = load float, ptr %Arg_1.115, align 4, !alias.scope !18, !noalias !16
  %4 = call reassoc float @llvm.maximum.f32(float %2, float %3)
  store float %4, ptr %maximum.116, align 4, !alias.scope !16
  %load_ret_value = load float, ptr %maximum.116, align 4
...
!12 = distinct !{!12, !10}
!13 = !{!14}
!14 = !{!"buffer: {index:146, offset:0, size:4}", !15}
!15 = !{!"XLA global AA domain"}
!16 = !{!17}
!17 = !{!"buffer: {index:76, offset:0, size:4}", !15}
!18 = !{!19}
!19 = !{!"buffer: {index:147, offset:0, size:4}", !15}
