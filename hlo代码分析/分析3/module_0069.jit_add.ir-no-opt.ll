...
@broadcast_add_fusion.clone_parallel_bounds = private constant [4 x [1 x [2 x i64]]] [[1 x [2 x i64]] [[2 x i64] [i64 0, i64 8]], [1 x [2 x i64]] [[2 x i64] [i64 8, i64 16]], [1 x [2 x i64]] [[2 x i64] [i64 16, i64 24]], [1 x [2 x i64]] [[2 x i64] [i64 24, i64 32]]]
...
define ptr @broadcast_add_fusion.clone(ptr %0) #0 {
  ...
  %lo_dim_0_gep = getelementptr inbounds [4 x [1 x [2 x i64]]], ptr @broadcast_add_fusion.clone_parallel_bounds, i32 0, i64 %workgroup_id_x, i32 0, i32 0
  %up_dim_0_gep = getelementptr inbounds [4 x [1 x [2 x i64]]], ptr @broadcast_add_fusion.clone_parallel_bounds, i32 0, i64 %workgroup_id_x, i32 0, i32 1
...
broadcast_add_fusion.clone.loop_header.dim.2:     ; preds = %broadcast_add_fusion.clone.loop_body.dim.2, %broadcast_add_fusion.clone.loop_body.dim.1
  ...
  %4 = icmp uge i64 %broadcast_add_fusion.clone.indvar.dim.2, 4096
...
broadcast_add_fusion.clone.loop_body.dim.2:       ; preds = %broadcast_add_fusion.clone.loop_header.dim.2
  %5 = getelementptr inbounds [32 x [512 x [4096 x float]]], ptr %arg0, i64 0, i64 %broadcast_add_fusion.clone.indvar.dim.0, i64 %broadcast_add_fusion.clone.indvar.dim.1, i64 %broadcast_add_fusion.clone.indvar.dim.2
  %6 = load float, ptr %5, align 4, !invariant.load !1, !noalias !5
  %7 = getelementptr inbounds [1 x [1 x [4096 x float]]], ptr %arg1, i64 0, i64 0, i64 0, i64 %broadcast_add_fusion.clone.indvar.dim.2
  %8 = load float, ptr %7, align 4, !invariant.load !1, !noalias !5
  %add.1 = fadd float %6, %8
  %9 = getelementptr inbounds [32 x [512 x [4096 x float]]], ptr %arg2, i64 0, i64 %broadcast_add_fusion.clone.indvar.dim.0, i64 %broadcast_add_fusion.clone.indvar.dim.1, i64 %broadcast_add_fusion.clone.indvar.dim.2
  store float %add.1, ptr %9, align 4, !alias.scope !5
  %invar.inc6 = add nuw nsw i64 %broadcast_add_fusion.clone.indvar.dim.2, 1
  store i64 %invar.inc6, ptr %broadcast_add_fusion.clone.invar_address.dim.2, align 4
  br label %broadcast_add_fusion.clone.loop_header.dim.2

broadcast_add_fusion.clone.loop_exit.dim.2:       ; preds = %broadcast_add_fusion.clone.loop_header.dim.2
  %invar.inc5 = add nuw nsw i64 %broadcast_add_fusion.clone.indvar.dim.1, 1
  store i64 %invar.inc5, ptr %broadcast_add_fusion.clone.invar_address.dim.1, align 4
  br label %broadcast_add_fusion.clone.loop_header.dim.1, !llvm.loop !8
...
broadcast_add_fusion.clone.loop_exit.dim.1:       ; preds = %broadcast_add_fusion.clone.loop_header.dim.1
  ...
  br label %broadcast_add_fusion.clone.loop_header.dim.0, !llvm.loop !10
