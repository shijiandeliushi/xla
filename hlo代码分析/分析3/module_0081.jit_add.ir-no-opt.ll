...
broadcast_add_fusion.clone.loop_body.dim.2:       ; preds = %broadcast_add_fusion.clone.loop_header.dim.2
  %5 = load float, ptr %arg1, align 4, !invariant.load !1, !noalias !5
  %6 = getelementptr inbounds [32 x [512 x [4096 x float]]], ptr %arg0, i64 0, i64 %broadcast_add_fusion.clone.indvar.dim.0, i64 %broadcast_add_fusion.clone.indvar.dim.1, i64 %broadcast_add_fusion.clone.indvar.dim.2
  %7 = load float, ptr %6, align 4, !invariant.load !1, !noalias !5
  %add.1 = fadd float %5, %7
  %8 = getelementptr inbounds [32 x [512 x [4096 x float]]], ptr %arg2, i64 0, i64 %broadcast_add_fusion.clone.indvar.dim.0, i64 %broadcast_add_fusion.clone.indvar.dim.1, i64 %broadcast_add_fusion.clone.indvar.dim.2
  store float %add.1, ptr %8, align 4, !alias.scope !5
