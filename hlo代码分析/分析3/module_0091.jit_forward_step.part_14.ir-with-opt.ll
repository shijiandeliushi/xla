...
@subtract_exponential_fusion.4.clone_parallel_bounds = private unnamed_addr constant [4 x [1 x [2 x i64]]] [[1 x [2 x i64]] [[2 x i64] [i64 0, i64 8]], [1 x [2 x i64]] [[2 x i64] [i64 8, i64 16]], [1 x [2 x i64]] [[2 x i64] [i64 16, i64 24]], [1 x [2 x i64]] [[2 x i64] [i64 24, i64 32]]]

; Function Attrs: nofree norecurse nosync nounwind memory(readwrite, inaccessiblemem: none) uwtable
define noalias noundef ptr @subtract_exponential_fusion.4.clone(ptr readonly captures(none) %0) local_unnamed_addr #0 {
  ...
  %lo_dim_0_gep = getelementptr inbounds [4 x [1 x [2 x i64]]], ptr @subtract_exponential_fusion.4.clone_parallel_bounds, i64 0, i64 %workgroup_id_x, i64 0, i64 0
  %up_dim_0_gep = getelementptr inbounds [4 x [1 x [2 x i64]]], ptr @subtract_exponential_fusion.4.clone_parallel_bounds, i64 0, i64 %workgroup_id_x, i64 0, i64 1
  %lo_dim_0 = load i64, ptr %lo_dim_0_gep, align 16
  %up_dim_0 = load i64, ptr %up_dim_0_gep, align 8
  %.not4 = icmp ult i64 %lo_dim_0, %up_dim_0
  br i1 %.not4, label %subtract_exponential_fusion.4.clone.loop_header.dim.1.preheader, label %return

subtract_exponential_fusion.4.clone.loop_header.dim.1.preheader: ; preds = %1, %subtract_exponential_fusion.4.clone.loop_exit.dim.1
  %subtract_exponential_fusion.4.clone.invar_address.dim.0.05 = phi i64 [ %invar.inc, %subtract_exponential_fusion.4.clone.loop_exit.dim.1 ], [ %lo_dim_0, %1 ]
  br label %subtract_exponential_fusion.4.clone.loop_header.dim.2.preheader

subtract_exponential_fusion.4.clone.loop_header.dim.2.preheader: ; preds = %subtract_exponential_fusion.4.clone.loop_header.dim.1.preheader, %subtract_exponential_fusion.4.clone.loop_exit.dim.2
  %subtract_exponential_fusion.4.clone.invar_address.dim.1.03 = phi i64 [ 0, %subtract_exponential_fusion.4.clone.loop_header.dim.1.preheader ], [ %invar.inc5, %subtract_exponential_fusion.4.clone.loop_exit.dim.2 ]
  br label %vector.ph

vector.ph:                                        ; preds = %subtract_exponential_fusion.4.clone.loop_exit.dim.3, %subtract_exponential_fusion.4.clone.loop_header.dim.2.preheader
  %subtract_exponential_fusion.4.clone.invar_address.dim.2.02 = phi i64 [ 0, %subtract_exponential_fusion.4.clone.loop_header.dim.2.preheader ], [ %invar.inc6, %subtract_exponential_fusion.4.clone.loop_exit.dim.3 ]
  %2 = getelementptr inbounds [32 x [16 x [512 x float]]], ptr %arg0, i64 0, i64 %subtract_exponential_fusion.4.clone.invar_address.dim.0.05, i64 %subtract_exponential_fusion.4.clone.invar_address.dim.1.03, i64 %subtract_exponential_fusion.4.clone.invar_address.dim.2.02
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %4 = getelementptr inbounds [32 x [16 x [512 x [512 x float]]]], ptr %arg1, i64 0, i64 %subtract_exponential_fusion.4.clone.invar_address.dim.0.05, i64 %subtract_exponential_fusion.4.clone.invar_address.dim.1.03, i64 %subtract_exponential_fusion.4.clone.invar_address.dim.2.02, i64 %index
  ...
  %76 = getelementptr inbounds [32 x [16 x [512 x [512 x float]]]], ptr %arg2, i64 0, i64 %subtract_exponential_fusion.4.clone.invar_address.dim.0.05, i64 %subtract_exponential_fusion.4.clone.invar_address.dim.1.03, i64 %subtract_exponential_fusion.4.clone.invar_address.dim.2.02, i64 %index
  ...
  br i1 %80, label %subtract_exponential_fusion.4.clone.loop_exit.dim.3, label %vector.body, !llvm.loop !8

subtract_exponential_fusion.4.clone.loop_exit.dim.3: ; preds = %vector.body
  %invar.inc6 = add nuw nsw i64 %subtract_exponential_fusion.4.clone.invar_address.dim.2.02, 1
  %exitcond6 = icmp eq i64 %invar.inc6, 512
  br i1 %exitcond6, label %subtract_exponential_fusion.4.clone.loop_exit.dim.2, label %vector.ph, !llvm.loop !11

subtract_exponential_fusion.4.clone.loop_exit.dim.2: ; preds = %subtract_exponential_fusion.4.clone.loop_exit.dim.3
  %invar.inc5 = add nuw nsw i64 %subtract_exponential_fusion.4.clone.invar_address.dim.1.03, 1
  %exitcond7 = icmp eq i64 %invar.inc5, 16
  br i1 %exitcond7, label %subtract_exponential_fusion.4.clone.loop_exit.dim.1, label %subtract_exponential_fusion.4.clone.loop_header.dim.2.preheader, !llvm.loop !13

subtract_exponential_fusion.4.clone.loop_exit.dim.1: ; preds = %subtract_exponential_fusion.4.clone.loop_exit.dim.2
  %invar.inc = add nuw nsw i64 %subtract_exponential_fusion.4.clone.invar_address.dim.0.05, 1
  %exitcond8.not = icmp eq i64 %invar.inc, %up_dim_0
  br i1 %exitcond8.not, label %return, label %subtract_exponential_fusion.4.clone.loop_header.dim.1.preheader, !llvm.loop !14

return:                                           ; preds = %subtract_exponential_fusion.4.clone.loop_exit.dim.1, %1
  ret ptr null
}
