...
@__llvmsplit_unnamed.6 = private unnamed_addr constant [8 x i8] c"\00\01\00\00\00\00\00\00"
@broadcast_add_fusion.2.clone_parallel_bounds = private constant [2 x [1 x [2 x i64]]] [[1 x [2 x i64]] [[2 x i64] [i64 0, i64 256]], [1 x [2 x i64]] [[2 x i64] [i64 256, i64 512]]]
...
define ptr @broadcast_add_fusion.2.clone(ptr %0) #0 {
  ...
  %lo_dim_0_gep = getelementptr inbounds [2 x [1 x [2 x i64]]], ptr @broadcast_add_fusion.2.clone_parallel_bounds, i32 0, i64 %workgroup_id_x, i32 0, i32 0
  %up_dim_0_gep = getelementptr inbounds [2 x [1 x [2 x i64]]], ptr @broadcast_add_fusion.2.clone_parallel_bounds, i32 0, i64 %workgroup_id_x, i32 0, i32 1
...
broadcast_add_fusion.2.clone.loop_header.dim.1:   ; preds = %broadcast_add_fusion.2.clone.loop_body.dim.1, %broadcast_add_fusion.2.clone.loop_body.dim.0
  ...
  %3 = icmp uge i64 %broadcast_add_fusion.2.clone.indvar.dim.1, 256
...
broadcast_add_fusion.2.clone.loop_body.dim.1:     ; preds = %broadcast_add_fusion.2.clone.loop_header.dim.1
  ...
  %13 = add i32 %10, %12
  %14 = getelementptr inbounds [512 x [256 x i32]], ptr %arg1, i64 0, i64 %broadcast_add_fusion.2.clone.indvar.dim.0, i64 %broadcast_add_fusion.2.clone.indvar.dim.1
