...
maximum_minimum_fusion.clone.loop_header.dim.1:   ; preds = %maximum_minimum_fusion.clone.loop_body.dim.1, %maximum_minimum_fusion.clone.loop_body.dim.0
  ...
  %3 = icmp uge i64 %maximum_minimum_fusion.clone.indvar.dim.1, 1024
...
maximum_minimum_fusion.clone.loop_body.dim.1:     ; preds = %maximum_minimum_fusion.clone.loop_header.dim.1
  ...
  %53 = getelementptr inbounds [4096 x [1024 x i32]], ptr %arg2, i64 0, i64 %maximum_minimum_fusion.clone.indvar.dim.0, i64 %maximum_minimum_fusion.clone.indvar.dim.1
  %54 = load i32, ptr %53, align 4, !invariant.load !1, !noalias !5
  %55 = getelementptr inbounds [4096 x [1024 x i32]], ptr %arg3, i64 0, i64 %maximum_minimum_fusion.clone.indvar.dim.0, i64 %maximum_minimum_fusion.clone.indvar.dim.1
  ...
  %135 = getelementptr inbounds [4096 x [1024 x float]], ptr %arg6, i64 0, i64 %maximum_minimum_fusion.clone.indvar.dim.0, i64 %maximum_minimum_fusion.clone.indvar.dim.1
